...
- Some issues may only be backend or platform FGEecific.
...
**Example B**: your engine runs on Windows, Mac, Linux and uses DirectX11, Metal, and Vulkan reFGEectively.<BR>
...
extra layer to the Platform and Renderer backends, which allows Dear ImGui to communicate platform-FGEecific
