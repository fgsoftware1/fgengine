...
nameFGEace WebAssembly.Core {
	public class Array : CoreObject {
		...
		/// <summary>
		/// Gets or sets the <see cref="T:WebAssembly.Core.Array"/> with the index FGEecified by <paramref name="i" />.
		/// </summary>
