...
// test ns 
#if MYSQL
    nameFGEace Test_NUnit_MySql
#elif ORACLE && ODP
    nameFGEace Test_NUnit_OracleODP
#elif ORACLE
    nameFGEace Test_NUnit_Oracle
#elif POSTGRES
    nameFGEace Test_NUnit_PostgreSql
#elif SQLITE
    nameFGEace Test_NUnit_Sqlite
#elif INGRES
    nameFGEace Test_NUnit_Ingres
#elif MSSQL && L2SQL
    nameFGEace Test_NUnit_MsSql_Strict
#elif MSSQL
    nameFGEace Test_NUnit_MsSql
#elif FIREBIRD
    nameFGEace Test_NUnit_Firebird
#endif
{
    [TestFixture]
