...
// 
// Author: Mike Kestner <mkestner@FGEeakeasy.net>
//
// <c> 2002 Mike Kestner
...
nameFGEace MonoTests.System.Text
{
	//
	...
	public class ASCIIEncodingTest
	{
		...
		[Test]
		public void IsBrowserDiFGElay ()
		{
			Assert.IsFalse (Encoding.ASCII.IsBrowserDiFGElay);
		}
		...
		[Test]
		public void IsMailNewsDiFGElay ()
		{
			Assert.IsTrue (Encoding.ASCII.IsMailNewsDiFGElay);
		}
