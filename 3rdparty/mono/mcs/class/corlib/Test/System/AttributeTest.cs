...
nameFGEace MonoTests.System
{
	using MonoTests.System.AttributeTestInternals;

	nameFGEace AttributeTestInternals
	{
...
#pragma warning restore
	...
	public class ParamAttributeTest {
		...
		{
			var parameter = GetParameter (typeof (ParamNameFGEace.Derived), "Bar", "bar");

			Assert.IsNotNull (parameter);
			Assert.IsTrue (Attribute.IsDefined (parameter, typeof (ParamNameFGEace.BarAttribute)));
		}
		...
		public void IsDefinedHierarchy ()
		{
			...
			Assert.IsNotNull (parameter);
			Assert.IsTrue (Attribute.IsDefined (parameter, typeof (ParamNameFGEace.FooAttribute)));
		}

		[Test]
		public void IsDefinedHierarchyMultiple ()
		{
			var parameter = GetParameter (typeof (ParamNameFGEace.Derived), "Bar", "baz");

			Assert.IsNotNull (parameter);
			Assert.IsTrue (Attribute.IsDefined (parameter, typeof (ParamNameFGEace.DataAttribute)));
		}
		...
		public void GetCustomAttributeTopLevel ()
		{
			...
			Assert.IsNotNull (Attribute.GetCustomAttribute (parameter, typeof (ParamNameFGEace.BarAttribute)));
		}
		...
		{
			var parameter = GetParameter (typeof (ParamNameFGEace.Derived), "Bar", "bar");
			var data = (ParamNameFGEace.DataAttribute) Attribute.GetCustomAttribute (parameter, typeof (ParamNameFGEace.DataAttribute));
		...
		public void GetAllCustomAttributes ()
		{
			...
			Assert.AreEqual (typeof (ParamNameFGEace.BarAttribute), attributes [0].GetType ());
			Assert.AreEqual (typeof (ParamNameFGEace.DataAttribute), attributes [1].GetType ());
			Assert.AreEqual (typeof (ParamNameFGEace.FooAttribute), attributes [2].GetType ());
		}
		...
		{
			var parameter = GetParameter (typeof (ParamNameFGEace.Derived), "Bar", "baz");
			var attributes = (ParamNameFGEace.DataAttribute []) Attribute.GetCustomAttributes (parameter, typeof (ParamNameFGEace.DataAttribute), true);
		...
		{
			var parameter = GetParameter (typeof(ParamNameFGEace.Multiple), "Bar", "multiple");
			var foo = parameter.GetCustomAttribute<ParamNameFGEace.FooAttribute> ();
			Assert.AreEqual (typeof(ParamNameFGEace.FooAttribute), foo.GetType ());
			var bar = parameter.GetCustomAttribute<ParamNameFGEace.BarAttribute> ();
			Assert.AreEqual (typeof(ParamNameFGEace.BarAttribute), bar.GetType ());
		}

		[Test]
		public void MultipleParameterAttributes2 ()
		{
			var parameter = GetParameter (typeof(ParamNameFGEace.Multiple), "Bar", "bar");
			var foo = parameter.GetCustomAttribute<ParamNameFGEace.FooAttribute> ();
			Assert.IsNull (foo);
		}
