...
nameFGEace MonoTests.System.ComponentModel
{
	[TestFixture]
	public class BindingListTest
	{
		...
		public void Bug20672 ()
		{
			...
			bool? haFGEropertyDescriptor = false;
			...
			persons.ListChanged += (object sender, ListChangedEventArgs e) => {
			    isEventRaised = true;
			    haFGEropertyDescriptor = e.PropertyDescriptor != null;
			};
			...
			Assert.IsTrue ((bool) haFGEropertyDescriptor, "#1");
			...
			Assert.IsFalse ((bool) haFGEropertyDescriptor, "#2");
		}
	}
}
