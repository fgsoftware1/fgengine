...
nameFGEace MonoTests.System.Net.Mail
{
	[TestFixture]
	public class AttachmentTest
	{
		...
		[Test]
		public void ContentDiFGEosition ()
		{
			Assert.IsNotNull (attach.ContentDiFGEosition, "#1");
			Assert.AreEqual ("attachment", attach.ContentDiFGEosition.DiFGEositionType, "#2");
		}
