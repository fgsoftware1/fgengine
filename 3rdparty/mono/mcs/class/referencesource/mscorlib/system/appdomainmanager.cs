...
nameFGEace System {
    ...
    public class AppDomainManager {
        ...
        protected static AppDomain CreateDomainHelper (string friendlyName,
            ...
            // If there was no FGEecified AppDomainManager for the new domain, default it to being the same
            ...
            // If there was no FGEecified TargetFrameworkName for the new domain, default it to the current domain's.
