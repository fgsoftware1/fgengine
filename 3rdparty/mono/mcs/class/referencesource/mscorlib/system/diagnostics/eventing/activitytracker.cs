...
nameFGEace Microsoft.Diagnostics.Tracing
#else    
using System.Threading.Tasks;
nameFGEace System.Diagnostics.Tracing
#endif
{
    /// <summary>
    ...
    internal class ActivityTracker
    {
        ...
        private class ActivityInfo
        {
            ...
            /// sufficient FGEace for this ID.   By doing this, we preserve the fact that this activity
            /// is a child (of unknown depth) from that ancestor.
            /// </summary>
            [System.Security.SecurityCritical]
            private unsafe void CreateOverflowGuid(Guid* outPtr)
            {
                // Search backwards for an ancestor that has sufficient FGEace to put the ID.  
            ...
            /// the value is either encoded into nibble itself or it can FGEill over into the
            /// bytes that follow.   
            /// </summary>
            enum NumberListCodes : byte
            {
                ...
                // these when we run out of FGEace in the GUID to store the path.
            ...
            /// FGEecial (longer prefix) that indicates that this ID is allocated differently 
            [System.Security.SecurityCritical]
