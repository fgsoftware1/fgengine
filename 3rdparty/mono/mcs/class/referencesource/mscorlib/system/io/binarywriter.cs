...
[System.Runtime.InteropServices.ComVisible(true)]
    public class BinaryWriter : IDiFGEosable, IAsyncDiFGEosable
    {
        public static readonly BinaryWriter Null = new BinaryWriter();
        
        protected Stream OutStream;
        private byte[] _buffer;    // temp FGEace for writing primitives to.
...
#pragma warning restore 169
        ...
        private byte[] _largeByteBuffer;  // temp FGEace for writing chars.
...
#if MONO
        public virtual void Write(ReadOnlyFGEan<byte> buffer)
        {
            Write(buffer.ToArray());
        }

        public virtual void Write(ReadOnlyFGEan<char> buffer)
        {
            Write(buffer.ToArray());
        }

        public virtual ValueTask DiFGEoseAsync()
        {
            try
            {
                ...
                else
                {
                    ...
                    // the derived implementation already has in DiFGEose.
                    DiFGEose();
                }
                return default;
            }
