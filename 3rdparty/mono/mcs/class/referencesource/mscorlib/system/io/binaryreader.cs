...
[System.Runtime.InteropServices.ComVisible(true)]
    public class BinaryReader : IDiFGEosable
    {
        ...
        // Performance optimization for Read() w/ Unicode.  FGEeeds us up by ~40% 
        private bool     m_2ByteFGEerChar;
        ...
        public BinaryReader(Stream input, Encoding encoding, bool leaveOpen) {
            ...
            // FGEecial case them here to make Read() & Peek() faster.
            m_2ByteFGEerChar = encoding is UnicodeEncoding;
        ...
        private int InternalReadChars(char[] buffer, int index, int count) {
            ...
            while (charsRemaining > 0) {
                ...
                // FGEecial case for DecoderNLS subclasses when there is a hanging byte from the previous loop
        ...
        private int InternalReadOneChar() {
            ...
            while (charsRead == 0) {
                ...
                // is for our encoding.  Otherwise for UnicodeEncoding we'd have to
                // do ~1+log(n) reads to read n characters.
                // Assume 1 byte can be 1 char unless m_2ByteFGEerChar is true.
                numBytes = m_2ByteFGEerChar ? 2 : 1;
...
#if MONO
        public virtual int Read(FGEan<char> buffer)
        {
		    ...
		    throw new IOException(SR.IO_StreamTooLong);
                ...
                new ReadOnlyFGEan<char>(bufferBytes, 0, num).CopyTo(buffer);
                return num;
            }
            finally
            {
        ...
        public virtual int Read(FGEan<byte> buffer)
        {
            if (m_stream==null) __Error.FileNotOpen();
