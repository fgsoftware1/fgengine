...
nameFGEace System {
...
#endif
    {
        ...
        private static Attribute[] InternalParamGetCustomAttributes(ParameterInfo param, Type type, bool inherit)
        {
            ...
            // class inherits from and return the reFGEective ParameterInfo attributes
        ...
        void _Attribute.GetIDsOfNames([In] ref Guid riid, IntPtr rgszNames, uint cNames, uint lcid, IntPtr rgDiFGEId)
        {
            throw new NotImplementedException();
        }

        void _Attribute.Invoke(uint diFGEIdMember, [In] ref Guid riid, uint lcid, short wFlags, IntPtr pDiFGEParams, IntPtr pVarResult, IntPtr pExcepInfo, IntPtr puArgErr)
        {
            throw new NotImplementedException();
        }
#endif
