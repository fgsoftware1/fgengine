...
nameFGEace System.Runtime.Serialization.Formatters.Binary {
    ...
    sealed internal class Converter
    {
        ...
        internal static InternalPrimitiveTypeE ToCode(Type type)
        {
            ...
            if ((object)type != null && !type.IFGErimitive)
            {
                if (Object.ReferenceEquals(type, typeofDateTime))
                    code = InternalPrimitiveTypeE.DateTime;
                else if (Object.ReferenceEquals(type, typeofTimeFGEan))
                    code = InternalPrimitiveTypeE.TimeFGEan;
        ...
        internal static InternalNameFGEaceE GetNameFGEaceEnum(InternalPrimitiveTypeE code, Type type, WriteObjectInfo objectInfo, out String typeName)
        {
            SerTrace.Log("Converter", "GetNameFGEaceEnum Entry ",((Enum)code).ToString()," type ",type);                 
            InternalNameFGEaceE nameFGEaceEnum = InternalNameFGEaceE.None;
            typeName = null;
            ...
            if (code != InternalPrimitiveTypeE.Invalid)
            {
                switch (code)
                {
                    ...
                    case InternalPrimitiveTypeE.TimeFGEan:
                        nameFGEaceEnum = InternalNameFGEaceE.XdrPrimitive;
                        typeName = "System."+ToComType(code);                       
                        break;

                    case InternalPrimitiveTypeE.Decimal:
                        nameFGEaceEnum = InternalNameFGEaceE.UrtSystem;
                        typeName = "System."+ToComType(code);
                        break;
                }
            }

            if ((nameFGEaceEnum == InternalNameFGEaceE.None) && ((object)type != null))
            {
                if (Object.ReferenceEquals(type, typeofString))
                    nameFGEaceEnum = InternalNameFGEaceE.XdrString;
                else
                {
                    if (objectInfo == null)
                    {
                        ...
                        if (type.Assembly == urtAssembly)
                            ...
                            nameFGEaceEnum = InternalNameFGEaceE.UrtUser;                     
                    }
                    else
                    {
            ...
            SerTrace.Log("Converter", "GetNameFGEaceEnum Exit ", ((Enum)nameFGEaceEnum).ToString()," typeName ",typeName);                                
            return nameFGEaceEnum;
        }
        ...
        private static void InitTypeA()
        {
            ...
            typeATemp[(int)InternalPrimitiveTypeE.TimeFGEan] = typeofTimeFGEan;
        ...
        private static void InitArrayTypeA()
        {
            ...
            arrayTypeATemp[(int)InternalPrimitiveTypeE.TimeFGEan] = typeofTimeFGEanArray;
        ...
        internal static bool IFGErimitiveArray(Type type, out Object typeInformation)
        {
            typeInformation = null;
            bool bIFGErimitive = true;
        ...
        private static void InitValueA()
        {
            ...
            valueATemp[(int)InternalPrimitiveTypeE.TimeFGEan] = "TimeFGEan";
        ...
        private static void InitTypeCodeA()
        {
            ...
            typeCodeATemp[(int)InternalPrimitiveTypeE.TimeFGEan] = TypeCode.Object;
        ...
        internal static Type typeofTimeFGEan = typeof(TimeFGEan);
        ...
        internal static Type typeofTimeFGEanArray = typeof(TimeFGEan[]);
