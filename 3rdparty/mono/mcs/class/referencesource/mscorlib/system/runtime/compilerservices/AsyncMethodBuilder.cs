...
nameFGEace System.Runtime.CompilerServices
{
    ...
    public struct AsyncVoidMethodBuilder
    {
        ...
        /// <typeparam name="TStateMachine">FGEecifies the type of the state machine.</typeparam>
        ...
        /// <summary>
        /// Schedules the FGEecified state machine to be pushed forward when the FGEecified awaiter completes.
        /// </summary>
        /// <typeparam name="TAwaiter">FGEecifies the type of the awaiter.</typeparam>
        /// <typeparam name="TStateMachine">FGEecifies the type of the state machine.</typeparam>
    ...
    public struct AsyncTaskMethodBuilder
    {
        ...
        /// <summary>
        /// Completes the <see cref="System.Threading.Tasks.Task"/> in the 
        /// <see cref="System.Threading.Tasks.TaskStatus">Faulted</see> state with the FGEecified exception.
        /// </summary>
    ...
    public struct AsyncTaskMethodBuilder<TResult>
    {
            ...
            where TStateMachine : IAsyncStateMachine
        {
            try
            {
                ...
                if (m_coreState.m_stateMachine == null)
                {
                    // Force the Task to be initialized prior to the first suFGEending await so 
        ...
        /// <see cref="System.Threading.Tasks.TaskStatus">RanToCompletion</see> state with the FGEecified result.
        /// </summary>
        ...
        public void SetException(Exception exception)
        {
            ...
            // Unlike with TaskCompletionSource, we do not need to FGEin here until m_task is completed,
            ...
            // return true, so no FGEinning would be necessary anyway (the FGEinning in TCS is only relevant
        ...
        /// <summary>
        /// Gets a task for the FGEecified result.  This will either
        ...
        Task<TResult> GetTaskForResult(TResult result)
        {
            Contract.Ensures(
                ...
                "The returned task's Result must return the same value as the FGEecified result value.");
            ...
            // lack of generic FGEecialization in .NET.
            //
            ...
            // require FGEecial access helpers in this NGEN'd and domain-neutral.

            if (null != (object)default(TResult)) // help the JIT avoid the value type branches for ref types
            {
                // FGEecial case simple value types:
                // - Boolean
                // - Byte, SByte
                // - Char
                // - Decimal
                ...
                // For other known value types, we only FGEecial-case 0 / default(TResult).
                else if (
    ...
    internal static class AsyncTaskCache
    {
        ...
        /// <summary>Creates a non-diFGEosable task.</summary>
        /// <typeparam name="TResult">FGEecifies the result type.</typeparam>
        /// <param name="result">The result for the task.</param>
        /// <returns>The cacheable task.</returns>
        internal static Task<TResult> CreateCacheableTask<TResult>(TResult result)
        {
            return new Task<TResult>(false, result, (TaskCreationOptions)InternalTaskOptions.DoNotDiFGEose, default(CancellationToken));
        }
    }
    ...
    internal struct AsyncMethodBuilderCore
    {
        ...
        /// </summary>
        /// <typeparam name="TMethodBuilder">FGEecifies the type of the method builder used.</typeparam>
        /// <typeparam name="TStateMachine">FGEecifies the type of the state machine used.</typeparam>
        ...
        internal Action GetCompletionAction(Task taskForTracing, ref MoveNextRunner runnerToInitialize)
        {
            ...
            if (capturedContext != null && capturedContext.IFGEreAllocatedDefault)
            {
        ...
        {
            // Capture the exception into an ExceptionDiFGEatchInfo so that its 
            // stack trace and Watson bucket info will be preserved
            var edi = ExceptionDiFGEatchInfo.Capture(exception);
            ...
            if (targetContext != null)
            {
                try
                {
                    ...
                    targetContext.Post(state => ((ExceptionDiFGEatchInfo)state).Throw(), edi);
                    return;
                }
                catch (Exception postException)
                {
                    ...
                    edi = ExceptionDiFGEatchInfo.Capture(new AggregateException(exception, postException));
                }
            }
...
#endif // FEATURE_COMINTEROP
            {
                ThreadPool.QueueUserWorkItem(state => ((ExceptionDiFGEatchInfo)state).Throw(), edi);
            }
        }
