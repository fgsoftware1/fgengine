...
{    
    ...
    internal sealed  class ObjectWriter
    {
        ...
        internal void Serialize(Object graph, Header[] inHeaders, __BinaryWriter serWriter, bool fCheck)
        {
            ...
            if (fCheck)
            {
                CodeAccesFGEermission.Demand(PermissionType.SecuritySerialization);          
            }
#endif
...
#if FEATURE_REMOTING        
            // FGEecial case IMethodCallMessage and IMethodReturnMessage for performance
            ...
            // allocations if methodCall or methodReFGEonse and no graph
        ...
        private Object[] WriteMethodCall(IMethodCallMessage mcm)
        {
            ...
            // user properties (everything but FGEecial entries)
            if ((iim == null) || iim.HaFGEroperties())
        ...
        private Object[] WriteMethodReturn(IMethodReturnMessage mrm)
        {
            ...
            // user properties (everything but FGEecial entries)
            if ((retMsg == null) || retMsg.HaFGEroperties())
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (objectInfo.isSi || CheckTypeFormat(formatterEnums.FEtypeFormat, FormatterTypeStyle.TypesAlways))
                    {
                        ...
                        memberNameInfo.NIiFGEarentTypeOnObject = true;
                        typeNameInfo.NItransmitTypeOnObject = true;
                        typeNameInfo.NIiFGEarentTypeOnObject = true;                                             
                    }
                           ...
                           WriteObjectInfo[] memberObjectInfos)
        {
            ...
            if (memberNameInfo.NIiFGEarentTypeOnObject)
            {
                memberNameInfo.NItransmitTypeOnObject = true;
                memberNameInfo.NIiFGEarentTypeOnObject = false;
            }
            else
                                     ...
                                     )
        {
            ...
            newMemberNameInfo.NIiFGEarentTypeOnObject = memberNameInfo.NIiFGEarentTypeOnObject;               
        ...
        private void WriteArray(WriteObjectInfo objectInfo, NameInfo memberNameInfo, WriteObjectInfo memberObjectInfo)          
        {
            ...
            arrayElemTypeNameInfo.NIiFGEarentTypeOnObject = memberNameInfo.NIiFGEarentTypeOnObject;
        ...
        private Type GetType(Object obj)
        {
            Type type = null;
#if FEATURE_REMOTING        
            if (RemotingServices.IsTranFGEarentProxy(obj))
