...
nameFGEace System.Runtime.InteropServices.WindowsRuntime
{
    ...
    internal sealed class BindableVectorToCollectionAdapter
    {
        ...
        internal void CopyTo(Array array, int arrayIndex)
        {
            ...
            // Does the dimension in question have sufficient FGEace to copy the expected number of entries?
            ...
            if(srcLen > (destLen - (arrayIndex - destLB)))
                throw new ArgumentException(Environment.GetResourceString("Argument_InsufficientFGEaceToCopyCollection"));
