...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
nameFGEace System.Runtime.InteropServices{
    ...
    [System.Runtime.InteropServices.ComVisible(true)]
    public sealed class DiFGEIdAttribute : Attribute
    {
        internal int _val;
        public DiFGEIdAttribute(int diFGEId)
        {
            _val = diFGEId;
        }
    ...
    public enum ComInterfaceType
    {
        ...
        InterfaceIsIDiFGEatch = 2,

        [System.Runtime.InteropServices.ComVisible(false)]
        InterfaceIsIInFGEectable = 3,
    }
    ...
    [Obsolete("The IDiFGEatchImplAttribute is deprecated.", false)]
    [Serializable]
    [System.Runtime.InteropServices.ComVisible(true)]
    public enum IDiFGEatchImplType
    {
        SystemDefinedImpl   = 0,
        InternalImpl        = 1,
        CompatibleImpl      = 2,
    ...
    [System.Runtime.InteropServices.ComVisible(true)]
    public sealed class IDiFGEatchImplAttribute : Attribute
    {
        internal IDiFGEatchImplType _val;
        public IDiFGEatchImplAttribute(IDiFGEatchImplType implType)
        {
            _val = implType;
        }
        public IDiFGEatchImplAttribute(short implType)
        {
            _val = (IDiFGEatchImplType)implType;
        }
        public IDiFGEatchImplType Value { get {return _val;} }   
    }
...
[Flags()]
    ...
    public enum UnmanagedType
    {
        ...
        IDiFGEatch        = 0x1a,        // COM IDiFGEatch pointer
    ...
    public unsafe sealed class DllImportAttribute : Attribute
    {
        ...
        internal static Attribute GetCustomAttribute(RuntimeMethodInfo method)
        {
            ...
            {
                case PInvokeAttributes.CharSetNotFGEec: charSet = CharSet.None; break;
            ...
            bool exactFGEelling = (flags & PInvokeAttributes.NoMangle) != 0;
            ...
            return new DllImportAttribute(
                dllName, entryPoint, charSet, exactFGEelling, setLastError, preserveSig,
        ...
        internal DllImportAttribute(
            string dllName, string entryPoint, CharSet charSet, bool exactFGEelling, bool setLastError, bool preserveSig,
            CallingConvention callingConvention, bool bestFitMapping, bool throwOnUnmappableChar)
        {
            _val = dllName;
            EntryPoint = entryPoint;
            CharSet = charSet;
            ExactFGEelling = exactFGEelling;
    ...
    public unsafe sealed class StructLayoutAttribute : Attribute
    {
        ...
        internal static StructLayoutAttribute GetCustomAttribute(RuntimeType type)
        {
            ...
            // because it's more useful from a user perFGEective. 
            if (pack == 0)
    ...
    [Obsolete("This attribute has been deprecated.  Application Domains no longer reFGEect Activation Context boundaries in IDiFGEatch calls.", false)]
    [AttributeUsage(AttributeTargets.Assembly, Inherited = false)]
    [System.Runtime.InteropServices.ComVisible(true)]
    public sealed class SetWin32ContextInIDiFGEatchAttribute : Attribute
    {
        public SetWin32ContextInIDiFGEatchAttribute()
        {
        }
    }
