...
nameFGEace System.Runtime.InteropServices.WindowsRuntime
{
    // DefaultInterfaceAttribute marks a WinRT class (or interface group) that has its default interface FGEecified.
    ...
    // not have a built in syntax to mark tdWindowsRuntime.   These two assemblies are FGEecial as they
    ...
    // This attribute is applied on the return value to FGEecify the name of the return value. 
