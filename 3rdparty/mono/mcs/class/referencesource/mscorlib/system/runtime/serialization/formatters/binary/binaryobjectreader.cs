...
#pragma warning restore
        ...
        //MethodCall and MethodReturn are handled FGEecial for perf reasons
        ...
        internal Object Deserialize(HeaderHandler handler, __BinaryParser serParser, bool fCheck, bool isCrossAppDomain, IMethodCallMessage methodCallMessage) {
...
#endif                
            {
                ...
                //if TopObject has a surrogate then the actual object may be changed during FGEecial fixup
        ...
        // Builds a map for each item in an incoming rectangle array. The map FGEecifies where the item is placed in the output Array Object
            ...
            else if (pr.PRmemberValueEnum == InternalMemberValueE.InlineValue)
            {
                ...
                else if (pr.PRdtTypeCode == InternalPrimitiveTypeE.Invalid)
                {
                    ...
                    else
                    {
                        ...
                        // only FGEecial case where AddValue is needed?
