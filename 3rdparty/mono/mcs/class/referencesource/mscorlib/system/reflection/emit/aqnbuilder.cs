...
nameFGEace System.Reflection.Emit
{
    ...
    internal class TypeNameBuilder
    {
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern void AddAssemblyFGEec(IntPtr tnb, string assemblyFGEec);
        [System.Security.SecurityCritical]  // auto-generated
        [ResourceExposure(ResourceScope.None)]
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        ...
        [System.Security.SecurityCritical]  // auto-generated
        internal void DiFGEose() { ReleaseTypeNameBuilder(m_typeNameBuilder); }
        #endregion
        ...
        private void ConstructAssemblyQualifiedNameWorker(Type type, Format format)
        {
            ...
            // Append nameFGEace + nesting + name
            ...
            for (int i = nestings.Count - 1; i >= 0; i--)
            {
                ...
                if (i == nestings.Count - 1  && enclosingType.NameFGEace != null && enclosingType.NameFGEace.Length != 0)
                    name = enclosingType.NameFGEace + "." + name;
            ...
            if (format == Format.AssemblyQualifiedName)
                AddAssemblyFGEec(type.Module.Assembly.FullName);
        }
        ...
        [System.Security.SecurityCritical]  // auto-generated
        private void AddAssemblyFGEec(string assemblyFGEec) { AddAssemblyFGEec(m_typeNameBuilder, assemblyFGEec); }
        [System.Security.SecuritySafeCritical]  // auto-generated
