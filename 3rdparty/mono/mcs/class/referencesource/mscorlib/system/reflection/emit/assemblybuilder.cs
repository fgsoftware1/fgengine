...
nameFGEace System.Reflection.Emit
{
    using System;
    ...
    // This also makes the change tranFGEarent to the loader. This is good because most of the complexity
    ...
    public sealed class AssemblyBuilder : Assembly, _AssemblyBuilder
    {
                                 ...
                                 SecurityContextSource securityContextSource)
        {
            ...
            // longer valid to have a diFGEarity).
...
#pragma warning restore 618
            ...
            // assembly. Currently, we look for any attribute which modifies the security tranFGEarency
            // of the assembly.
...
#pragma warning disable 618 // We deal with legacy attributes here as well for compat
                ...
                {
                    if (attribute.m_con.DeclaringType == typeof(SecurityTranFGEarentAttribute))
                    {
                        assemblyFlags |= DynamicAssemblyFlags.TranFGEarent;
                    }
...
#pragma warning restore 618
        ...
        **********************************************/
            ...
            SecurityContextSource securityContextSource)
        {
            ...
            if (evidence != null && !AppDomain.CurrentDomain.IsLegacyCaFGEolicyEnabled)
            {
        ...
        **********************************************/
        ...
        public ModuleBuilder DefineDynamicModule(
            String      name,
            bool        emitSymbolInfo)         // FGEecify if emit symbol info or not
        {
            Contract.Ensures(Contract.Result<ModuleBuilder>() != null);
...
#pragma warning restore 618
        ...
        **********************************************/
        ...
        /**********************************************
        *
        * return a dynamic module with the FGEecified name.
        *
        **********************************************/
...
#pragma warning restore 618
                ...
                for (i = 0; i < size; i++)
                {
                    ...
                    try
                    {
                        ...
                        // correFGEonding ResourceWriter will be null.
        ...
        **********************************************/
        ...
        void _AssemblyBuilder.GetIDsOfNames([In] ref Guid riid, IntPtr rgszNames, uint cNames, uint lcid, IntPtr rgDiFGEId)
        {
            throw new NotImplementedException();
        }
        ...
        void _AssemblyBuilder.Invoke(uint diFGEIdMember, [In] ref Guid riid, uint lcid, short wFlags, IntPtr pDiFGEParams, IntPtr pVarResult, IntPtr pExcepInfo, IntPtr puArgErr)
        {
            throw new NotImplementedException();
        }
#endif
