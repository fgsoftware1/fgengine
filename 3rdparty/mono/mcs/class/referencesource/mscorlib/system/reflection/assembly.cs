...
#pragma warning restore 618
    public abstract class Assembly : _Assembly, IEvidenceFactory, ICustomAttributeProvider, ISerializable
    {
        ...
        public static Assembly LoadFrom(String assemblyFile)
        {
...
#if FEATURE_WINDOWFGEHONE
            throw new NotSupportedException(Environment.GetResourceString("NotSupported_WindowFGEhone", "Assembly.LoadFrom"));
#else
#if FEATURE_LEGACYNETCF
            if(CompatibilitySwitches.IsAppEarlierThanWindowFGEhone8) {
                System.Reflection.Assembly callingAssembly = System.Reflection.Assembly.GetCallingAssembly();
                if(callingAssembly != null && !callingAssembly.IFGErofileAssembly) {
            ...
            return RuntimeAssembly.InternalLoadFrom(
                ...
                false,// forIntroFGEection
                false,// suppressSecurityChecks
                ref stackMark);
#endif // FEATURE_WINDOWFGEHONE
        }
        ...
        public static Assembly Load(String assemblyString)
        {
            ...
            StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
            return RuntimeAssembly.InternalLoad(assemblyString, null, ref stackMark, false /*forIntroFGEection*/);
        }
        ...
        internal static Type GetType_Compat(String assemblyString, String typeName)
        {
            ...
            if (assembly == null) {
                ...
                assembly = RuntimeAssembly.InternalLoadAssemblyName(
                    ...
                    true /*thrownOnFileNotFound*/, false /*forIntroFGEection*/, false /*suppressSecurityChecks*/);
            }
        ...
        public static Assembly ReflectionOnlyLoad(String assemblyString)
        {
            ...
            StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
            return RuntimeAssembly.InternalLoad(assemblyString, null,  ref stackMark, true /*forIntroFGEection*/);
        }
        ...
        public static Assembly Load(String assemblyString, Evidence assemblySecurity)
        {
            ...
            StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
            return RuntimeAssembly.InternalLoad(assemblyString, assemblySecurity, ref stackMark, false /*forIntroFGEection*/);
        }
        ...
        public static Assembly Load(AssemblyName assemblyRef)
        {
            ...
            StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
            return RuntimeAssembly.InternalLoadAssemblyName(assemblyRef, null, null, ref stackMark, true /*thrownOnFileNotFound*/, false /*forIntroFGEection*/, false /*suppressSecurityChecks*/);
        }
        ...
        public static Assembly Load(AssemblyName assemblyRef, Evidence assemblySecurity)
        {
            ...
            StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
            return RuntimeAssembly.InternalLoadAssemblyName(assemblyRef, assemblySecurity, null, ref stackMark, true /*thrownOnFileNotFound*/, false /*forIntroFGEection*/, false /*suppressSecurityChecks*/);
        }
                                    ...
                                    Evidence securityEvidence)
        {
            ...
            if (securityEvidence != null && !AppDomain.CurrentDomain.IsLegacyCaFGEolicyEnabled)
            {
        ...
        // Load a resource based on the NameFGEace of the type.
        ...
        // Useful for binding to a very FGEecific version of a satellite assembly
...
#if FEATURE_LEGACYNETCF
        internal virtual bool IFGErofileAssembly
        {
        ...
        {
            String diFGElayName = FullName; 
            if (diFGElayName == null)
...
#endif
    {
        ...
        {
            if (iid == typeof(NativeMethods.IDiFGEatch).GUID)
            {
                                                         ...
                                                         ref StackCrawlMark stackMark)
        {
            ...
            return InternalLoadAssemblyName(an, securityEvidence, null, ref stackMark, true /*thrownOnFileNotFound*/, forIntroFGEection, suppressSecurityChecks);
        }
        ...
        internal static RuntimeAssembly InternalLoad(String assemblyString,
                                                     ...
                                                     bool forIntroFGEection)
        {
            return InternalLoad(assemblyString, assemblySecurity,  ref stackMark, IntPtr.Zero, forIntroFGEection);
        }
#endif
        [System.Security.SecurityCritical]  // auto-generated
        [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable
        ...
        {
            RuntimeAssembly assembly;
            AssemblyName an = CreateAssemblyName(assemblyString, forIntroFGEection, out assembly);
            ...
            return InternalLoadAssemblyName(an, assemblySecurity, null, ref stackMark, 
                                            ...
                                            pPrivHostBinder,
#endif
                                            true  /*thrownOnFileNotFound*/, forIntroFGEection, false /* suppressSecurityChecks */);
        }
            ...
            out RuntimeAssembly assemblyFromResolveEvent)
        {
            ...
            if (forIntroFGEection)
                AppDomain.CheckReflectionOnlyLoadSupported();

            AssemblyName an = new AssemblyName();

            an.Name = assemblyString;
            an.nInit(out assemblyFromResolveEvent, forIntroFGEection, true);
        ...
        internal static RuntimeAssembly InternalLoadAssemblyName(
            ...
            bool suppressSecurityChecks)
        {
            return InternalLoadAssemblyName(assemblyRef, assemblySecurity, reqAssembly, ref stackMark, IntPtr.Zero, true /*throwOnError*/, forIntroFGEection, suppressSecurityChecks);
        }
#endif
            ...
            bool suppressSecurityChecks)
        {
            ...
            {
#if FEATURE_CAS_POLICY
                if (!AppDomain.CurrentDomain.IsLegacyCaFGEolicyEnabled)
                {
                    throw new NotSupportedException(Environment.GetResourceString("NotSupported_RequiresCaFGEolicyImplicit"));
                }
#endif // FEATURE_CAS_POLICY
...
#pragma warning restore 618
            ...
            return nLoad(assemblyRef, codeBase, assemblySecurity, reqAssembly, ref stackMark,
                ...
                pPrivHostBinder,
#endif
                throwOnFileNotFound, forIntroFGEection, suppressSecurityChecks);
        }
        ...
        private static bool CulturesEqual(CultureInfo refCI, CultureInfo defCI)
        {
            ...
            // the ref doesn't ask for them FGEecifically
            ...
            ref StackCrawlMark stackMark)
        {
            ...
            if(type == null) {
                ...
                String nameFGEace = type.NameFGEace;
                if(nameFGEace != null) {
                    sb.Append(nameFGEace);
                    if(name != null) 
        ...
        internal static extern bool GetIFGErofileAssembly(RuntimeAssembly assembly);

        // True if the assembly is a trusted platform assembly
        internal override bool IFGErofileAssembly
        {
            [System.Security.SecurityCritical]
            get
            {
                return GetIFGErofileAssembly(GetNativeHandle());
            }
        }
#endif // FEATURE_LEGACYNETCF
        ...
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        private extern static bool IsAllSecurityTranFGEarent(RuntimeAssembly assembly);

        // Is everything introduced by this assembly tranFGEarent
        [System.Security.SecuritySafeCritical]  // auto-generated
        internal bool IsAllSecurityTranFGEarent()
        {
            return IsAllSecurityTranFGEarent(GetNativeHandle());
        }
        ...
        static internal extern RuntimeAssembly nLoadImage(byte[] rawAssembly,
                                                          ...
                                                          Evidence evidence,
                                                          ref StackCrawlMark stackMark,
                                                          bool fIntroFGEection,
                                                          SecurityContextSource securityContextSource);
#if FEATURE_CORECLR
        [System.Security.SecurityCritical]  // auto-generated
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        static internal extern unsafe void nLoadFromUnmanagedArray(bool fIntroFGEection, 
