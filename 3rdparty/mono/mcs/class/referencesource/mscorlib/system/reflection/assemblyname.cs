...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class AssemblyName : _AssemblyName, ICloneable, ISerializable, IDeserializationCallback
    {
        ...
        // the name partitions up the strong name's nameFGEace
        public String Name
        {
            get { return _Name; }
            set { _Name = value; }
        ...
        // inclusion into the nameFGEace. If the public key associated
        // with the nameFGEace cannot verify the assembly the assembly
        // will fail to load.
        public byte[] GetPublicKey()
        {
#if FEATURE_LEGACYNETCF
            if (CompatibilitySwitches.IsAppEarlierThanWindowFGEhone8 && _PublicKey == null)
        ...
        public String FullName
        {
            ...
            get {
                ...
                if (CompatibilitySwitches.IsAppEarlierThanWindowFGEhone8 && string.IsNullOrEmpty(name))
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern void nInit(out RuntimeAssembly assembly, bool forIntroFGEection, bool raiseResolveEvent);
        ...
        void _AssemblyName.GetIDsOfNames([In] ref Guid riid, IntPtr rgszNames, uint cNames, uint lcid, IntPtr rgDiFGEId)
        {
            throw new NotImplementedException();
        }

        void _AssemblyName.Invoke(uint diFGEIdMember, [In] ref Guid riid, uint lcid, short wFlags, IntPtr pDiFGEParams, IntPtr pVarResult, IntPtr pExcepInfo, IntPtr puArgErr)
        {
            throw new NotImplementedException();
        }
#endif
