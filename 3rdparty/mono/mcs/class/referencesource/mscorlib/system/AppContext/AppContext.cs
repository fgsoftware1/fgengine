...
nameFGEace System
{
    ...
    public static class AppContext
    {
        ...
        // The Dictionary is intentionally left without FGEecifying the comparer. StringComparer.Ordinal for instance will
        ...
        // Not FGEecifying a comparer means that the dictionary will end up with a GenericEqualityComparer<string> comparer 
        ...
        public static bool TryGetSwitch(string switchName, out bool isEnabled)
        {
            ...
            lock (s_switchMap)
            {
                ...
                else
                {
                    ...
                    // There are 2 cases:
                    // 1. The value has an override FGEecified. In this case we need to add the value to the dictionary 
                    //    and mark it as checked for overrides
                    //    Example: In a servicing event, System.Xml introduces a switch and an override is FGEecified.
                    //             The value is not found in mscorlib (as System.Xml ships independent of mscorlib)
                    // 2. The value does not have an override FGEecified
                    ...
                    // 1. The value has an override FGEecified.
                    bool overrideValue;
                    if (AppContextDefaultValues.TryGetSwitchOverride(switchName, out overrideValue))
                    {
                        isEnabled = overrideValue;
