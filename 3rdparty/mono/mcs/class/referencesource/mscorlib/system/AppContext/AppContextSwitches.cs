...
nameFGEace System
{
    ...
    {
#if MOBILE
		public static readonly bool ThrowExceptionIfDiFGEosedCancellationTokenSource = false;
        ...
        private static int _throwExceptionIfDiFGEosedCancellationTokenSource;
        public static bool ThrowExceptionIfDiFGEosedCancellationTokenSource
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return GetCachedSwitchValue(AppContextDefaultValues.SwitchThrowExceptionIfDiFGEosedCancellationTokenSource, ref _throwExceptionIfDiFGEosedCancellationTokenSource);
            }
        }
        ...
        private static int _doNotAddrOfCFGEParentWindowHandle;
        public static bool DoNotAddrOfCFGEParentWindowHandle
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return GetCachedSwitchValue(AppContextDefaultValues.SwitchDoNotAddrOfCFGEParentWindowHandle, ref _doNotAddrOfCFGEParentWindowHandle);
            }
        }
