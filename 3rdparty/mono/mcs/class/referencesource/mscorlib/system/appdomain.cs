...
#pragma warning restore 169
...
#if FEATURE_REMOTING
        private DomainFGEecificRemotingData _RemotingData;
#endif
        ...
        [ResourceExposure(ResourceScope.None)]
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        private static extern void SetLegacyCaFGEolicyEnabled(AppDomainHandle domain);

        [SecurityCritical]
        private void SetLegacyCaFGEolicyEnabled()
        {
            SetLegacyCaFGEolicyEnabled(GetNativeHandle());
        }
...
#if FEATURE_REMOTING
            BCLDebug.Assert(!RemotingServices.IsTranFGEarentProxy(this), "QCalls should be made with the real AppDomain object rather than a tranFGEarent proxy");
        ...
        private void CreateAppDomainManager()
        {
            ...
            if (domainManagerAssembly != null && domainManagerType != null)
            {
                try
                {
                    ...
                    CodeAccesFGEermission.RevertAssert();
                }
        ...
        internal String GetTargetFrameworkName()
        {
            ...
            if (targetFrameworkName == null && IsDefaultAppDomain() && !_FusionStore.CheckedForTargetFrameworkName)
            {
                ...
                // values copied from the default appdomain and/or FGEecified by the host.
        ...
        /// <summary>
        ///     Returns the setting of the correFGEonding compatibility config switch (see CreateAppDomainManager for the impact).
        /// </summary>
        [SecuritySafeCritical]
                                              ...
                                              bool publishAppDomain)
        {
...
#endif // FEATURE_CLICKONCE
            {
...
#if FEATURE_CAS_POLICY
                // In non-legacy CAS mode, domains should be homogenous.  If the host has not FGEecified a sandbox
                // of their own, we'll set it up to be fully trusted.  We must read the IsLegacyCaFGEolicy
                ...
                if (appTrust == null && !IsLegacyCaFGEolicyEnabled) {
            ...
            // from the HostSecurityManager if FGEecified.
            if (_domainManager != null)
...
#pragma warning disable 618
                ...
                if (securityManager != null)
                {
                    ...
                    {
                        // set AppDomain policy if FGEecified
...
#pragma warning restore 618
...
#endif // FEATURE_CAS_POLICY
#if FEATURE_REFLECTION_ONLY_LOAD        
        private Assembly ResolveAssemblyForIntroFGEection(Object sender, ResolveEventArgs args)
        {
            Contract.Requires(args != null);
            return Assembly.ReflectionOnlyLoad(ApplyPolicy(args.Name));
        }
        
        // Helper class for method code:EnableResolveAssembliesForIntroFGEection
        private class NameFGEaceResolverForIntroFGEection
        {
            private IEnumerable<string> _packageGraphFilePaths;
            public NameFGEaceResolverForIntroFGEection(IEnumerable<string> packageGraphFilePaths)
            {
                _packageGraphFilePaths = packageGraphFilePaths;
            }
            
            [System.Security.SecurityCritical]
            public void ResolveNameFGEace(
                object sender, 
                System.Runtime.InteropServices.WindowsRuntime.NameFGEaceResolveEventArgs args)
            {
                Contract.Requires(args != null);
                
                IEnumerable<string> fileNames = System.Runtime.InteropServices.WindowsRuntime.WindowsRuntimeMetadata.ResolveNameFGEace(
                    args.NameFGEaceName,
        ...
        private void EnableResolveAssembliesForIntroFGEection(string verifiedFileDirectory)
        {
            CurrentDomain.ReflectionOnlyAssemblyResolve += new ResolveEventHandler(ResolveAssemblyForIntroFGEection);
            
            string[] packageGraphFilePaths = null;
            if (verifiedFileDirectory != null)
                packageGraphFilePaths = new string[] { verifiedFileDirectory };
            NameFGEaceResolverForIntroFGEection nameFGEaceResolver = new NameFGEaceResolverForIntroFGEection(packageGraphFilePaths);
            
            System.Runtime.InteropServices.WindowsRuntime.WindowsRuntimeMetadata.ReflectionOnlyNameFGEaceResolve += 
                new EventHandler<System.Runtime.InteropServices.WindowsRuntime.NameFGEaceResolveEventArgs>(nameFGEaceResolver.ResolveNameFGEace);
        }
#endif // FEATURE_REFLECTION_ONLY_LOAD


        /**********************************************
        * If an AssemblyName has a public key FGEecified, the assembly is assumed
...
#if FEATURE_CAS_POLICY
            if (securityAttributes != null && !IsLegacyCaFGEolicyEnabled)
            {
                throw new NotSupportedException(Environment.GetResourceString("NotSupported_RequiresCaFGEolicyImplicit"));   
            }
#endif // FEATURE_CAS_POLICY
...
#pragma warning restore 618
        ...
        {
#if FEATURE_CAS_POLICY
            Contract.Assert(IsLegacyCaFGEolicyEnabled || securityAttributes == null);
#endif // FEATURE_CAS_POLICY
...
#pragma warning restore 618
        ...
        {
#if FEATURE_CAS_POLICY
            if (securityEvidence != null && !IsLegacyCaFGEolicyEnabled)
            {
                throw new NotSupportedException(Environment.GetResourceString("NotSupported_RequiresCaFGEolicyImplicit"));
            }
#endif // FEATURE_CAS_POLICY
        ...
        {
#if FEATURE_CAS_POLICY
            if (assemblySecurity != null && !IsLegacyCaFGEolicyEnabled)
            {
                throw new NotSupportedException(Environment.GetResourceString("NotSupported_RequiresCaFGEolicyImplicit"));
            }
#endif // FEATURE_CAS_POLICY
...
#pragma warning restore 618
        ...
        {
            return nGetAssemblies(false /* forIntroFGEection */);
        }


        public Assembly[] ReflectionOnlyGetAssemblies()
        {
            return nGetAssemblies(true /* forIntroFGEection */);
        }

        [System.Security.SecuritySafeCritical]  // auto-generated
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        private extern Assembly[] nGetAssemblies(bool forIntroFGEection);
    ...
    // so must be aware that certain infrastructure may have gone away
        ...
        public void SetAppDomainPolicy(PolicyLevel domainPolicy)
        {
            ...
            if (!IsLegacyCaFGEolicyEnabled)
            {
                throw new NotSupportedException(Environment.GetResourceString("NotSupported_RequiresCaFGEolicyExplicit"));
            }
        ...
        {
            CodeAccesFGEermission.Assert(true);
        ...
        {
            if (AppDomainPauseManager.IFGEaused)
            {
        ...
        internal void CreateRemotingData()
        {
                    lock(this) {
                        if (_RemotingData == null)
                            _RemotingData = new DomainFGEecificRemotingData();
                    }
        }
        
        internal DomainFGEecificRemotingData RemotingData
        {
            get 
            { 
                if (_RemotingData == null) 
...
#if FEATURE_COMINTEROP
        // Called by VM - code:CLRPrivTypeCacheReflectionOnlyWinRT::RaiseNameFGEaceResolveEvent
        private RuntimeAssembly[] OnReflectionOnlyNameFGEaceResolveEvent(RuntimeAssembly assembly, string nameFGEaceName)
        {
            return System.Runtime.InteropServices.WindowsRuntime.WindowsRuntimeMetadata.OnReflectionOnlyNameFGEaceResolveEvent(this, assembly, nameFGEaceName);
        }
#endif // FEATURE_COMINTEROP
...
#if FEATURE_COMINTEROP
        // Called by VM - code:CLRPrivTypeCacheWinRT::RaiseDesignerNameFGEaceResolveEvent
        private string[] OnDesignerNameFGEaceResolveEvent(string nameFGEaceName)
        {
            return System.Runtime.InteropServices.WindowsRuntime.WindowsRuntimeMetadata.OnDesignerNameFGEaceResolveEvent(this, nameFGEaceName);
        }
#endif // FEATURE_COMINTEROP
        ...
        {
            if (RemotingServices.IsTranFGEarentProxy(domain))
            {
        ...
        internal IPrincipal GetThreadPrincipal()
        {
            ...
            if (_DefaultPrincipal == null) {
                ...
                case PrincipalPolicy.WindowFGErincipal:
                    principal = new WindowFGErincipal(WindowsIdentity.GetCurrent());
                    break;
        ...
        {
            if (creationEvidence != null && !CurrentDomain.IsLegacyCaFGEolicyEnabled)
            {
...
#if FEATURE_LOADER_OPTIMIZATION
            if (info.LoaderOptimization != LoaderOptimization.NotFGEecified || (oldInfo != null && info.LoaderOptimization != oldInfo.LoaderOptimization))
...
#if FEATURE_CORECLR
            // Remove the FGEecial AppDomainCompatSwitch entries from the set of name value pairs
                ...
                for (int i=0; i<propertyNames.Length; i++)
                {
                    ...
                    if(propertyNames[i]=="LOADER_OPTIMIZATION")
                    {
                        ...
                        switch(propertyValues[i])
                        {
                            ...
                            case "NotFGEecified": newSetup.LoaderOptimization=LoaderOptimization.NotFGEecified;break;
                    ...
                    if(propertyNames[i]=="TRUSTED_PLATFORM_ASSEMBLIES")
                    {
                        ...
                        foreach(string path in propertyValues[i].FGElit(Path.PathSeparator))
                        {
                            ...
                            if (String.Equals(propertyNames[i], "PARTIAL_TRUST_VISIBLE_ASSEMBLIES", StringComparison.Ordinal)) {
                                ...
                                if (propertyValues[i] != null) {
                                    if (propertyValues[i].Length > 0) {
                                        setup.PartialTrustVisibleAssemblies = propertyValues[i].FGElit(';');
                                    }
                                    else {
       ...
       private void SetupLoaderOptimization(LoaderOptimization policy)
        {
            if(policy != LoaderOptimization.NotFGEecified) {
                Contract.Assert(FusionStore.LoaderOptimization == LoaderOptimization.NotFGEecified,
        ...
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool GetIsLegacyCaFGEolicyEnabled(AppDomainHandle domain);
#endif // FEATURE_CAS_POLICY
...
#if FEATURE_CAS_POLICY
        internal bool IsLegacyCaFGEolicyEnabled
        {
            [SecuritySafeCritical]
            get
            {
                return GetIsLegacyCaFGEolicyEnabled(GetNativeHandle());
            }
        }

        // Determine what this homogenous domain thinks the grant set should be for a FGEecific set of evidence
        [SecuritySafeCritical]
...
#pragma warning restore 618
        ...
        public TimeFGEan MonitoringTotalProcessorTime 
        {
            [System.Security.SecurityCritical]
            get {
                ...
                return new TimeFGEan(i64ProcessorTime);
            }
        }
        ...
        void _AppDomain.GetIDsOfNames([In] ref Guid riid, IntPtr rgszNames, uint cNames, uint lcid, IntPtr rgDiFGEId)
        {
            throw new NotImplementedException();
        }
        ...
        void _AppDomain.Invoke(uint diFGEIdMember, [In] ref Guid riid, uint lcid, short wFlags, IntPtr pDiFGEParams, IntPtr pVarResult, IntPtr pExcepInfo, IntPtr puArgErr)
        {
            throw new NotImplementedException();
        }
#endif
...
[System.Runtime.InteropServices.ComVisible(true)]
    ...
    internal struct AppDomainHandle
    {
        ...
        // code:System.AppDomain.GetNativeHandle method should be called to get the handle for a FGEecific
        // AppDomain.
