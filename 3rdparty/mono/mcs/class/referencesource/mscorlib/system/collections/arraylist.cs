...
nameFGEace System.Collections {
    ...
    public class ArrayList : IList, ICloneable
    {
        ...
        // Contains returns true if the FGEecified element is in the ArrayList.
        ...
        public virtual int LastIndexOf(Object value, int startIndex, int count) {
            ...
            if (_size == 0)  // FGEecial case for an empty list
                return -1;
        ...
        private class IListWrapper : ArrayList
        {
            ...
            public override void InsertRange(int index, ICollection c) {
                ...
                if( c.Count > 0) {
                    ...
                    if( al != null) { 
                        // We need to FGEecial case ArrayList. 
                        // When c is a range of _list, we need to handle this in a FGEecial way.
