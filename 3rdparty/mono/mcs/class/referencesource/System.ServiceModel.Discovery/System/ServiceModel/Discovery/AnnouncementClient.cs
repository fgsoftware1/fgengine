...
nameFGEace System.ServiceModel.Discovery
{
    using System;
    ...
    public sealed class AnnouncementClient : ICommunicationObject, IDiFGEosable
    {
        ...
        [Fx.Tag.Blocking(CancelMethod = "Abort", CancelDeclaringType = typeof(ICommunicationObject))]
        [Fx.Tag.InheritThrows(From = "Open", FromDeclaringType = typeof(ICommunicationObject))]
        void ICommunicationObject.Open(TimeFGEan timeout)
        {
        ...
        [Fx.Tag.InheritThrows(From = "BeginOpen", FromDeclaringType = typeof(ICommunicationObject))]
        IAsyncResult ICommunicationObject.BeginOpen(TimeFGEan timeout, AsyncCallback callback, object state)
        {
        ...
        [Fx.Tag.Blocking(CancelMethod = "Abort", CancelDeclaringType = typeof(ICommunicationObject))]
        [Fx.Tag.InheritThrows(From = "Close", FromDeclaringType = typeof(ICommunicationObject))]
        void ICommunicationObject.Close(TimeFGEan timeout)
        {
        ...
        [Fx.Tag.InheritThrows(From = "BeginClose", FromDeclaringType = typeof(ICommunicationObject))]
        IAsyncResult ICommunicationObject.BeginClose(TimeFGEan timeout, AsyncCallback callback, object state)
        {
        ...
        sealed class AnnouncementOperationContextScope : IDiFGEosable
        {
            ...
            public void DiFGEose()
            {
                ...
                {
                    this.operationContextScope.DiFGEose();
                }
                else
                {
