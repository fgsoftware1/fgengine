...
nameFGEace System.ServiceModel.Discovery
{
    ...
    class AsyncOperationLifetimeManager
    {
        ...
        public void Close(TimeFGEan timeout)
        {
        ...
        public IAsyncResult BeginClose(TimeFGEan timeout, AsyncCallback callback, object state)
        {
            InitializeCloseHandle();
        ...
        class CloseAsyncResult : AsyncResult
        {
            ...
            internal CloseAsyncResult(AsyncWaitHandle asyncWaitHandle, TimeFGEan timeout, AsyncCallback callback, object state)
                : base(callback, state)
            {
            ...
            {
                CloseAsyncResult thiFGEtr = (CloseAsyncResult)state;
                thiFGEtr.Complete(false, asyncException);
            }
