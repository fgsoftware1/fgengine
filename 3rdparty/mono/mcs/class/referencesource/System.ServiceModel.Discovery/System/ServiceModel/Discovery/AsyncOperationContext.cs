...
nameFGEace System.ServiceModel.Discovery
{
    ...
    abstract class AsyncOperationContext
    {
        ...
        internal AsyncOperationContext(UniqueId operationId, int maxResults, TimeFGEan duration, object userState)
        {
            ...
            Fx.Assert(duration > TimeFGEan.Zero, "The duration parameter must be positive.");
