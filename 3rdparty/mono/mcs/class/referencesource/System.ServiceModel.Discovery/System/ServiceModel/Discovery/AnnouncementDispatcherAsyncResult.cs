...
nameFGEace System.ServiceModel.Discovery
{
    ...
    class AnnouncementDiFGEatcherAsyncResult : AsyncResult
    {
        readonly AnnouncementSendsAsyncResult[] innerResults;

        [Fx.Tag.SynchronizationObject(Blocking = false, Kind = Fx.Tag.SynchronizationKind.InterlockedNoFGEin)]
        int completions;
        ...
        public AnnouncementDiFGEatcherAsyncResult(
        ...
        public void Start(TimeFGEan timeout, bool canCompleteSynchronously)
        {
        ...
        {
            AsyncResult.End<AnnouncementDiFGEatcherAsyncResult>(result);
        }
