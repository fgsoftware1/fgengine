...
//              selected range is then diFGElayed as a scaleView. 
//
...
#endif
{
    ...
    /// <summary>
    /// AxisScaleView class represents a scale view which allows to diFGElay 
    ...
    public class AxisScaleView
	{
		...
		/// <summary>
		/// Call this method to scroll to a FGEecified position along an axis.
		/// </summary>
		...
		/// <summary>
		/// Internal helper method for scrolling into FGEecified position.
		/// </summary>
		...
		/// <summary>
		/// Sets a new axis data view/position based on the start and end dates FGEecified.
		/// </summary>
		...
		/// <summary>
		/// Sets a new axis data view/position based on the FGEecified start and end values.
		/// </summary>
        ...
        /// <summary>
		/// Reset the FGEecified number of zooming operations by restoring axis data view. 
		/// </summary>
		...
		{	
			// Scroll line size/type is FGEecificly set by user
