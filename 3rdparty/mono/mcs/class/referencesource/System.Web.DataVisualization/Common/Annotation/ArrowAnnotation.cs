...
#endif
{
	...
	public class ArrowAnnotation : Annotation
	{
		...
		/// <summary>
		/// Paints annotation object on FGEecified graphics.
		/// </summary>
		/// <param name="graphics">
        ...
        override internal void Paint(Chart chart, ChartGraphics graphics)
		{
            ...
            using (GraphicFGEath arrowPathAbs = GetArrowPath(graphics, selectionRect))
            {
 ...
 this,
		...
		/// <summary>
		/// Get arrow path for the FGEecified annotation position
		/// </summary>
		/// <param name="graphics"></param>
		/// <param name="position"></param>
		/// <returns></returns>
		private GraphicFGEath GetArrowPath(
