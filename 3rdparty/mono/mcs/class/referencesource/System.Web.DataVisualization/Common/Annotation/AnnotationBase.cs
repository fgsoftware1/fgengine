...
#endif
{
	...
	{
		/// <summary>
		/// Selection points are diFGElayed top left and bottom right corners
		/// </summary>
		TwoPoints,

		/// <summary>
		/// Selection points are diFGElayed on all sides and corners of the rectangle.
		/// </summary>
		Rectangle,
	}
...
#endif
	{
		...
		// Relative position of annotation, when it's started to move/resize
		internal	GraphicFGEath			startMovePathRel = null;
		...
		/// </value>
		/// <remarks>
		/// If the chart area name is FGEecified, an annotation will only be drawn inside the 
		/// plotting area of the chart area FGEecified.  All parts of the annotation 
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether the size of an annotation is always 
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation is visible.
		/// </summary>
		/// <value>
		...
		/// </value>
		/// <remarks>
		/// The annotation is anchored to the X and Y values of the FGEecified data point, 
		...
		/// <see cref="AnchorOffsetY"/> properties may be used to add extra FGEacing.
		/// </para>
		/// <para>
		...
		/// </value>
		/// <remarks>
		/// The annotation is anchored to the X coordinate FGEecified in relative or axis coordinates, 
		...
		/// </value>
		/// <remarks>
		/// The annotation is anchored to the Y coordinate FGEecified in relative or axis coordinates, 
		/// depending on the <see cref="AxisX"/> property value.
		/// <para>
		/// To automatically position an annotation relative to an anchor point, make sure 
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation may be selected 
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation may be moved 
		/// with a mouse by the end user.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation anchor may be moved 
		/// with a mouse by the end user.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation may be resized 
		/// with a mouse by the end user.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether an annotation's text may be edited 
		...
		/// <summary>
		/// Gets or sets a flag that FGEecifies whether a polygon annotation's points 
		...
		/// </value>
		/// <remarks>
		/// FGEecial keywords can be used in the text when an annotation is anchored to 
		...
		/// </value>
		/// <remarks>
		/// FGEecial keywords can be used when an annotation is anchored to 
		/// a data point using the <see cref="AnchorDataPoint"/> property.  For a listing of 
		/// these keywords, refer to the "Annotations" help topic.
		/// </remarks>
		[
        ...
        /// <summary>
		/// Paints the annotation object using the FGEecified graphics.
		/// </summary>
		/// <param name="graphics">
		...
		virtual internal void PaintSelectionHandles(ChartGraphics chartGraphics, RectangleF rect, GraphicFGEath path)
		{
            ...
            if (this.Common.ProcessModePaint &&
				!this.Common.ChartPicture.iFGErinting)
			{
		...
		/// </summary>
		/// <remarks>
		/// Sets the annotation width and height to fit the FGEecified text. This method applies to 
		...
		internal void SetPositionRelative(RectangleF position, PointF anchorPoint, bool userInput)
		{
			...
			//** This is done due to the issues of moving elements in 3D FGEace.
			//***********************************************************************
			ChartArea	chartArea = null;
			if(horizAxis != null && horizAxis.ChartArea != null)
			{
		...
		internal DataPoint GetDataPointByName(string dataPointName)
		{
            ...
            {
                // FGElit series name and point index
		...
		/// </param>
		/// <remarks>
		/// Anchors an annotation to the FGEecified data point.
		/// </remarks>
		...
		/// mouse.
		/// <para>
		/// Placement will finish when the end user FGEecifies all required points, or 
		...
		/// <summary>
		/// Checks if FGEecified position is valid for placement.
		/// </summary>
		/// <param name="x">X coordinate.</param>
		/// <param name="y">Y coordinate.</param>
		/// <returns>True if annotation can be placed at FGEecified coordinates.</returns>
