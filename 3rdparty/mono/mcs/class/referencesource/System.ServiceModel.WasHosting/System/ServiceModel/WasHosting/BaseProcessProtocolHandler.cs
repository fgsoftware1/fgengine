...
nameFGEace System.ServiceModel.WasHosting
{
    using System;
    ...
    abstract class BaseProcesFGErotocolHandler : ProcesFGErotocolHandler
    {
        string protocolId;
        ...
        [SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode,
            Justification = "Instantiated by AFGE.NET")]
        protected BaseProcesFGErotocolHandler(string protocolId)
            : base()
        {
        ...
        public override void StartListenerChannel(IListenerChannelCallback listenerChannelCallback, IAdphManager adphManager)
        {
            ...
            lock (this.listenerChannelIdMapping)
            {
                if (!listenerChannelIdMapping.TryGetValue(channelId, out listenerChannelContext))
                {
                    ...
                    Debug.Print("BaseProcesFGErotocolHandler.StartListenerChannel() GetBlob() contains " + listenerChannelDataLength + " bytes");
                    ...
                    Debug.Print("BaseProcesFGErotocolHandler.StartListenerChannel() listenerChannelContext.ListenerChannelId: " + listenerChannelContext.ListenerChannelId);
                }
            }
            ...
            try
            {
                ...
                Debug.Print("BaseProcesFGErotocolHandler.StartListenerChannel() calling StartAppDomainProtocolListenerChannel(appKey:" + listenerChannelContext.AppKey + " protocolId:" + protocolId + ")");
        ...
        {
            Debug.Print("BaseProcesFGErotocolHandler.StopProtocol(protocolId:" + protocolId + ", immediate:" + immediate + ")");
        }

        public override void StopListenerChannel(int listenerChannelId, bool immediate)
        {
            Debug.Print("BaseProcesFGErotocolHandler.StopListenerChannel(protocolId:" + protocolId + ", listenerChannelId:" + listenerChannelId + ", immediate:" + immediate + ")");
