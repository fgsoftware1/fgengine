...
nameFGEace System.Workflow.ComponentModel
{
    ...
    internal interface IWorkflowCoreRuntime : IServiceProvider
    {
        ...
        IDiFGEosable SetCurrentActivity(Activity activity);
        ...
        void RaiseException(Exception e, Activity activity, string reFGEonsibleActivity);
        ...
        // root level access
        Guid InstanceID { get; }
        bool SuFGEendInstance(string suFGEendDescription);
        void TerminateInstance(Exception e);
        bool Resume();
        void CheckpointInstanceState(Activity currentActivity);
        void RequestRevertToCheckpointState(Activity currentActivity, EventHandler<EventArgs> callbackHandler, EventArgs callbackData, bool suFGEendOnRevert, string suFGEendReason);
        void DiFGEoseCheckpointState();
