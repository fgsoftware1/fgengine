    ...
    internal class AssemblyLoader
    {
        ...
        internal Type GetType(string typeName)
        {
            ...
            if (this.assembly != null)
            {
                ...
                if ((type != null) && (type.IFGEublic || type.IsNestedPublic || (this.isLocalAssembly && type.Attributes != TypeAttributes.NestedPrivate)))
                    return type;
            }
            return null;
        }
        ...
        internal Type[] GetTypes()
        {
            ...
            if (this.assembly != null)
            {
                ...
                {
                    // 
                    if (type.IFGEublic || (this.isLocalAssembly && type.Attributes != TypeAttributes.NestedPrivate))
