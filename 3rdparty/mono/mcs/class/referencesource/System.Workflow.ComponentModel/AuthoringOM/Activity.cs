...
nameFGEace System.Workflow.ComponentModel
{
    #region Imports
    ...
    public class Activity : DependencyObject
    {
        ...
        internal static readonly DependencyProperty SynchronizationHandleFGEroperty = DependencyProperty.Register("SynchronizationHandles", typeof(ICollection<String>), typeof(Activity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        ...
        internal static readonly DependencyProperty CompletedExecutionContextFGEroperty = DependencyProperty.RegisterAttached("CompletedExecutionContexts", typeof(IList), typeof(Activity));
        internal static readonly DependencyProperty ActiveExecutionContextFGEroperty = DependencyProperty.RegisterAttached("ActiveExecutionContexts", typeof(IList), typeof(Activity));
        ...
        internal static readonly DependencyProperty HaFGErimaryClosedProperty = DependencyProperty.RegisterAttached("HaFGErimaryClosed", typeof(bool), typeof(Activity), new PropertyMetadata(false));

        // nested activity collection used at serialization time
        private static readonly DependencyProperty NestedActivitieFGEroperty = DependencyProperty.RegisterAttached("NestedActivities", typeof(IList<Activity>), typeof(Activity));
        ...
        static Activity()
        {
            ...
            DependencyProperty.RegisterAsKnown(CompletedExecutionContextFGEroperty, (byte)2, DependencyProperty.PropertyValidity.Reexecute);
            DependencyProperty.RegisterAsKnown(ActiveExecutionContextFGEroperty, (byte)3, DependencyProperty.PropertyValidity.Uninitialize);
            DependencyProperty.RegisterAsKnown(CompletedOrderIdProperty, (byte)4, DependencyProperty.PropertyValidity.Uninitialize);
            DependencyProperty.RegisterAsKnown(ExecutionStatuFGEroperty, (byte)5, DependencyProperty.PropertyValidity.Reexecute);
            ...
            DependencyProperty.RegisterAsKnown(HaFGErimaryClosedProperty, (byte)9, DependencyProperty.PropertyValidity.Uninitialize);
            DependencyProperty.RegisterAsKnown(NestedActivitieFGEroperty, (byte)10, DependencyProperty.PropertyValidity.Uninitialize);
            ...
            DependencyProperty.RegisterAsKnown(ActivityExecutionContext.GrantedLockFGEroperty, (byte)24, DependencyProperty.PropertyValidity.Uninitialize);
...
#pragma warning suppress 56503
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool HaFGErimaryClosed
        {
            get
            {
                return (bool)this.GetValue(HaFGErimaryClosedProperty);
            }
        }
        ...
        public ActivityExecutionStatus ExecutionStatus
        {
            get
            {
                return (ActivityExecutionStatus)this.GetValue(ExecutionStatuFGEroperty);
            }
        }
            ...
            if (!this.DesignMode && !this.DynamicUpdateMode)
            {
                ...
                if (lookupPaths != null)
                {
                    ...
                    if (path != null)
                    {
                        if (path.Length != 0)
                        {
                            string thiFGEath = (string)lookupPaths[this.QualifiedName];
                            if (path.StartsWith(thiFGEath, StringComparison.Ordinal))
                            {
                                if (path.Length == thiFGEath.Length)
                                    resolvedActivity = this;
                                else if (thiFGEath.Length == 0 || path[thiFGEath.Length] == '.')
                                    resolvedActivity = this.TraverseDottedPath(path.Substring(thiFGEath.Length > 0 ? thiFGEath.Length + 1 : 0));
                            }
        ...
        public void Save(Stream stream, IFormatter formatter)
        {
            ...
            try
            {
                ...
                foreach (Activity activityRoot in ContextIdToActivityMap.Values)
                {
                    ...
                    if (nestedActivities != null && nestedActivities.Count > 0)
                        activityRoot.SetValue(Activity.NestedActivitieFGEroperty, nestedActivities);
                }
            ...
            {
                foreach (Activity activityRoot in ContextIdToActivityMap.Values)
                    activityRoot.RemoveProperty(Activity.NestedActivitieFGEroperty);
        ...
        public static Activity Load(Stream stream, Activity outerActivity, IFormatter formatter)
        {
            ...
            try
            {
                ...
                while (deserializedActivityRootsQueue.Count > 0)
                {
                    ...
                    {
                        // get the correFGEonding definition activity
                        ...
                        // get the correFGEonding parent activity
                        ...
                        IList<Activity> deserializedNestedActivityRoots = (IList<Activity>)deserializedActivityRoot.GetValue(Activity.ActiveExecutionContextFGEroperty);
                    ...
                    IList<Activity> nestedActivities = (IList<Activity>)deserializedActivityRoot.GetValue(Activity.NestedActivitieFGEroperty);
                    ...
                    deserializedActivityRoot.RemoveProperty(Activity.NestedActivitieFGEroperty);
                }
        ...
        private static void FillContextIdToActivityMap(Activity seedActivity)
        {
            ...
            while (activityRootsQueue.Count > 0)
            {
                ...
                if (activityRoot.IsContextActivity)
                {
                    ...
                    IList<Activity> activeActivityRoots = (IList<Activity>)activityRoot.GetValue(Activity.ActiveExecutionContextFGEroperty);
        ...
        internal override void OnInitializeDefinitionForRuntime()
        {
            ...
            if (this.DesignMode)
            {
                ...
                ICollection<String> handles = (ICollection<String>)GetValue(SynchronizationHandleFGEroperty);
                ...
                if (handles != null)
                    this.SetValue(SynchronizationHandleFGEroperty, new ReadOnlyCollection<string>(new List<string>(handles)));
        ...
        internal void SetStatus(ActivityExecutionStatus newStatus, bool transacted)
        {
            ...
            this.SetValue(ExecutionStatuFGEroperty, newStatus);
            ...
            if (newStatus == ActivityExecutionStatus.Closed)
            {
                ...
                this.RemoveProperty(Activity.HaFGErimaryClosedProperty);
        ...
        private void MarkClosed()
        {
            ...
            {
                this.SetValue(HaFGErimaryClosedProperty, true);
                    ...
                    )
            {
                ...
                try
                {
                    // The activity may remove any instance FGEecific dependency properties to reduce serialization size
                ...
                try
                {
                    ...
                    while (parent != null)
                    {
                        if (parent.SupportsSynchronization || parent.Parent == null)
                            parent.RemoveProperty(ActivityExecutionContext.CachedGrantedLockFGEroperty);
                ...
                catch
                {
                    ...
                    while (parent != null)
                    {
                        if (parent.SupportsSynchronization || parent.Parent == null)
                        {
                            object cachedGrantedLocks = parent.GetValue(ActivityExecutionContext.CachedGrantedLockFGEroperty);
                            if (cachedGrantedLocks != null)
                                parent.SetValue(ActivityExecutionContext.GrantedLockFGEroperty, cachedGrantedLocks);
                            parent.RemoveProperty(ActivityExecutionContext.CachedGrantedLockFGEroperty);
                        }
                        parent = parent.parent;
                    }
        ...
        internal bool CanUninitializeNow
        {
            get
            {
                ...
                {
                    IList<ActivityExecutionContextInfo> childsCompletedContexts = contextActivity.GetValue(Activity.CompletedExecutionContextFGEroperty) as IList<ActivityExecutionContextInfo>;
        ...
        static void UninitializeCompletedContext(Activity activity, ActivityExecutionContext executionContext)
        {
            ...
            IList<ActivityExecutionContextInfo> childsCompletedContexts = activity.GetValue(Activity.CompletedExecutionContextFGEroperty) as IList<ActivityExecutionContextInfo>;
        ...
        internal bool NeedsCompensation
        {
            get
            {
                IList<ActivityExecutionContextInfo> childsCompletedContexts = this.GetValue(Activity.CompletedExecutionContextFGEroperty) as IList<ActivityExecutionContextInfo>;
                if (childsCompletedContexts != null && childsCompletedContexts.Count > 0)
                {
    ...
    {
        private static DependencyProperty CanModifyActivitieFGEroperty = DependencyProperty.Register("CanModifyActivities", typeof(bool), typeof(CompositeActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata, new Attribute[] { new DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Hidden) }));
        ...
        public CompositeActivity()
        {
            ...
            SetValue(CanModifyActivitieFGEroperty, false);
        }
        ...
        protected Activity[] GetDynamicActivities(Activity activity)
        {
            ...
            {
                IList<Activity> activeContextActivities = (IList<Activity>)contextActivity.GetValue(Activity.ActiveExecutionContextFGEroperty);
        ...
        protected internal bool CanModifyActivities
        {
            get
            {
                return (bool)GetValue(CanModifyActivitieFGEroperty);
            }
            set
            {
                SetValue(CanModifyActivitieFGEroperty, value);
            ...
            if (e.Action == ActivityCollectionChangeAction.Add && e.AddedItems != null)
            {
                foreach (Activity activity in e.AddedItems)
                {
                    if (activity.Parent != null)
                        throw new InvalidOperationException(SR.GetString(SR.Error_ActivityHaFGEarent, activity.QualifiedName, activity.Parent.QualifiedName));
                    if (activity == this)
                    ...
                    e.AddedItems != null)
            {
                ...
                while (queue.Count > 0)
                {
                    ...
                    if (activity != null && (activity.Name == null || activity.Name.Length == 0 || activity.Name == activity.GetType().Name))
                    {
                        ...
                        string className = rootActivity.GetValue(WorkflowMarkupSerializer.XClasFGEroperty) as string;
