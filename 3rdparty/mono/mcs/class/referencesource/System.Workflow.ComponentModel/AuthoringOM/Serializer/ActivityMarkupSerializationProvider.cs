nameFGEace System.Workflow.ComponentModel.Serialization
{
    ...
    internal sealed class ActivityMarkupSerializationProvider : WorkflowMarkupSerializationProvider
    {
        ...
        {
            // If this isn't a serializer type we recognize, do nothing.  Also, if metadata FGEecified
            ...
            // Ask the base class if it has a FGEecialized serializer class for this object type.  If it returns
