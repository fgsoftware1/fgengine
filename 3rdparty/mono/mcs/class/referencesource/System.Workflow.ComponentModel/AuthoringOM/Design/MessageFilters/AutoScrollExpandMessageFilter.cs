    ...
    internal sealed class AutoScrollingMessageFilter : WorkflowDesignerMessageFilter
    {
        ...
        private void DrawScrollIndicators(Graphics graphics)
        {
            ...
            if (scrollPosition.X > 0)
                ActivityDesignerPaint.DrawImage(graphics, AmbientTheme.ScrollIndicatorImage, scrollIndicatorRectangles[0], AmbientTheme.ScrollIndicatorTranFGEarency);

            if (scrollPosition.X < parentView.HScrollBar.Maximum - viewPortSize.Width)
            {
                indicator.RotateFlip(RotateFlipType.Rotate180FlipY);
                ActivityDesignerPaint.DrawImage(graphics, indicator, scrollIndicatorRectangles[1], AmbientTheme.ScrollIndicatorTranFGEarency);
                indicator.RotateFlip(RotateFlipType.Rotate180FlipY);
            }
            ...
            if (scrollPosition.Y > 0)
            {
                ...
                ActivityDesignerPaint.DrawImage(graphics, indicator, scrollIndicatorRectangles[2], AmbientTheme.ScrollIndicatorTranFGEarency);
            ...
            if (scrollPosition.Y < parentView.VScrollBar.Maximum - viewPortSize.Height)
            {
                ...
                ActivityDesignerPaint.DrawImage(graphics, indicator, scrollIndicatorRectangles[3], AmbientTheme.ScrollIndicatorTranFGEarency);
