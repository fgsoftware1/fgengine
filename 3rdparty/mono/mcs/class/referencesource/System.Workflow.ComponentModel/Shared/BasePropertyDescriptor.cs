...
nameFGEace System.Workflow.ComponentModel.Design
{
    ...
    internal static class PropertyDescriptorUtils
    {
        ...
        {
            ComponentChangeDiFGEatcher componentChange = new ComponentChangeDiFGEatcher(serviceProvider, component, propertyDescriptor);
            try
            {
            ...
            {
                componentChange.DiFGEose();
            }
        }
    }
    #endregion

    #region Class ComponentChangeDiFGEatcher
    internal sealed class ComponentChangeDiFGEatcher : IDiFGEosable
    {
        ...
        public ComponentChangeDiFGEatcher(IServiceProvider serviceProvider, object component, PropertyDescriptor propertyDescriptor)
        {
    ...
    internal class DynamicPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override string DiFGElayName
        {
            get
            {
                return this.realPropertyDescriptor.DiFGElayName;
            }
        }
    ...
    internal class ParameterInfoBasedPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override void SetValue(object component, object value)
        {
            ...
            ComponentChangeDiFGEatcher componentChange = (serviceProvider != null) ? new ComponentChangeDiFGEatcher(serviceProvider, component, this) : null;
        ...
        {
            WorkflowParameterBindingCollection parameters = GetParameterBindings(component);
            string diFGElayName = this.Name;
            string propertyName = (diFGElayName.StartsWith(parameterPrefix, StringComparison.Ordinal)) ? diFGElayName.Substring(parameterPrefix.Length) : diFGElayName;
    ...
    internal class PropertyValueProviderTypeConverter : TypeConverter
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            IPropertyValueProvider valueFGErovider = null;
            object[] instances = context.Instance as object[];
            if (instances != null && instances.Length > 0)
                valueFGErovider = instances[0] as IPropertyValueProvider;
            else
                valueFGErovider = context.Instance as IPropertyValueProvider;

            ICollection values = new object[] { };
            if (valueFGErovider != null)
                values = valueFGErovider.GetPropertyValues(context);
    ...
    internal class TypePropertyValueProviderTypeConverter : TypePropertyTypeConverter
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            ICollection values = new object[] { };
            if (valueFGErovider != null && context != null)
                values = valueFGErovider.GetPropertyValues(context);
