...
using RSTR = System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenReFGEonse;
...
nameFGEace System.IdentityModel.Tokens
{
    ...
    public class AsymmetricProofDescriptor : ProofDescriptor
    {
        ...
        public override void ApplyTo( RSTR reFGEonse )
        {
            if ( reFGEonse == null )
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull( "reFGEonse" );
            }
            //
