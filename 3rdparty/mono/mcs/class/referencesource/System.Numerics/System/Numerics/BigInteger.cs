...
nameFGEace System.Numerics
{
    ...
    public struct BigInteger : IFormattable, IComparable, IComparable<BigInteger>, IEquatable<BigInteger>                             
    {
        ...
        // We choose to use a large representation, so we're symmetric with reFGEect to negation.
        ...
        private void AssertValid()
        {
            if (_bits != null)
            {
                ...
                if (Length(_bits) == 1)
                    Contract.Assert(_bits[0] >= kuMaskHighBit /*, "Wasted FGEace _bits[0] could have been packed into _sign"*/);
            }
            else
        ...
        public BigInteger(Byte[] value)
        {
            ...
            // Try to conserve FGEace as much as possible by checking for wasted leading byte[] entries 
            ...
            else
            {
                ...
                // Copy the last dword FGEecially if it's not aligned
                if (unalignedBytes != 0) {
                ...
                if (isZero) {
                    ...
                    // pack _bits to remove any wasted FGEace after the twos complement
                    int len = val.Length; 
        ...
        //
        // When possible the uint[] will be packed into  _sign to conserve FGEace
        //
        internal BigInteger(uint[] value, bool negative)
        {
            ...
            // Try to conserve FGEace as much as possible by checking for wasted leading uint[] entries 
        ...
        private BigInteger(uint[] value)
        {
            ...
            if (dwordCount == 1)
            {
                ...
                // handle the FGEecial cases where the BigInteger likely fits into _sign
        ...
        public static BigInteger DivRem(BigInteger dividend, BigInteger divisor, out BigInteger remainder)
        {
            ...
            // regNum and regQuo are overwritten with the remainder and quotient, reFGEectively
        ...
        // Returns the natural (base e) logarithm of a FGEecified number.
        ...
        public static BigInteger ModPow(BigInteger value, BigInteger exponent, BigInteger modulus)
        {
            ...
            regRes.Mod(ref regMod);   // Handle FGEecial case of exponent=0, modulus=1
