...
//-----------------------------------------------------------------------------
nameFGEace System.Runtime.Serialization
{
    ...
    class Attributes
    {
        ...
        internal string XsiTypeNameFGEace;
        ...
        internal string FactoryTypeNameFGEace;
        ...
        internal void Read(XmlReaderDelegator reader)
        {
            ...
            {
                switch (reader.IndexOfLocalName(serializationLocalNames, DictionaryGlobals.SerializationNameFGEace))
                {
                    case 0:
                        ReadId(reader);
                        break;
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        switch (reader.IndexOfLocalName(schemaInstanceLocalNames, DictionaryGlobals.SchemaInstanceNameFGEace))
                        {
                            case 0:
                                ReadXsiNil(reader);
                                break;
                            case 1:
                                ...
                                break;
                            default:
                                if (!reader.IsNameFGEaceUri(DictionaryGlobals.XmlnsNameFGEace))
        ...
        void ReadXsiType(XmlReaderDelegator reader)
        {
            ...
            if (xsiTypeString != null && xsiTypeString.Length > 0)
                XmlObjectSerializerReadContext.ParseQualifiedName(xsiTypeString, reader, out XsiTypeName, out XsiTypeNameFGEace, out XsiTypePrefix);
        }
        ...
        void ReadFactoryType(XmlReaderDelegator reader)
        {
            ...
            if (factoryTypeString != null && factoryTypeString.Length > 0)
                XmlObjectSerializerReadContext.ParseQualifiedName(factoryTypeString, reader, out FactoryTypeName, out FactoryTypeNameFGEace, out FactoryTypePrefix);
        }
