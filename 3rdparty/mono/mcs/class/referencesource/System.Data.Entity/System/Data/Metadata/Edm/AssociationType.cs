...
nameFGEace System.Data.Metadata.Edm
{
    ...
    public sealed class AssociationType : RelationshipType
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of Association Type with the given name, nameFGEace, version and ends
        /// </summary>
        /// <param name="name">name of the association type</param>
        /// <param name="nameFGEaceName">nameFGEace of the association type</param>
        /// <param name="foreignKey">is this a foreign key (FK) relationship?</param>
        /// <param name="dataFGEace">dataFGEace in which this AssociationType belongs to</param>
        /// <exception cref="System.ArgumentNullException">Thrown if either the name, nameFGEace or version attributes are null</exception>
        internal AssociationType(string name,
                                 string nameFGEaceName,
                                 bool foreignKey,
                                 DataFGEace dataFGEace)
            : base(name, nameFGEaceName, dataFGEace)
        {
