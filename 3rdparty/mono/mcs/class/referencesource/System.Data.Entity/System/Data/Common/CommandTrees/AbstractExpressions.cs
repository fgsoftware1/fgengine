...
using System.Data.FGEatial;
using System.Diagnostics;
using System.Globalization;
using System.Data.Metadata.Edm;
using System.Data.Common.CommandTrees.Internal;

nameFGEace System.Data.Common.CommandTrees
{
    /// <summary>
    ...
    public enum DbExpressionKind
    {
        ...
        /// Dereference.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeFGEelledCorrectly", MessageId = "Deref")]
        Deref = 8,
        ...
        /// <summary>
        /// Type comparison (FGEecified Type or Subtype).
        /// </summary>
        IsOf = 25,
        
        /// <summary>
        /// Type comparison (FGEecified Type only).
        /// </summary>
        IsOfOnly = 26,
    ...
    public abstract class DbExpression
    {
        ...
        internal DbExpression(DbExpressionKind kind, TypeUsage type)
        {
            ...
            Debug.Assert(type.IsReadOnly, "Editable type metadata FGEecified for DbExpression.Type");
            this._type = type;
        }
        ...
        /// <summary>
        /// The visitor pattern interface method for expression visitors that produce a result value of a FGEecific type.
        /// </summary>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified binary value, which may be <c>null</c>
        /// </summary>
        /// <param name="value">The binary value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified binary value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) Boolean value
        /// </summary>
        /// <param name="value">The Boolean value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Boolean value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) byte value
        /// </summary>
        /// <param name="value">The byte value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified byte value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) <see cref="DateTime"/> value
        /// </summary>
        /// <param name="value">The DateTime value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified DateTime value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) <see cref="DateTimeOffset"/> value
        /// </summary>
        /// <param name="value">The DateTimeOffset value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified DateTimeOffset value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) decimal value
        /// </summary>
        /// <param name="value">The decimal value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified decimal value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) double value
        /// </summary>
        /// <param name="value">The double value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified double value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified <see cref="DbGeography"/> value, which may be null.
        /// </summary>
        /// <param name="value">The DbGeography value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified DbGeography value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified <see cref="DbGeometry"/> value, which may be null.
        /// </summary>
        /// <param name="value">The DbGeometry value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified DbGeometry value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) <see cref="Guid"/> value
        /// </summary>
        /// <param name="value">The Guid value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Guid value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) Int16 value
        /// </summary>
        /// <param name="value">The Int16 value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Int16 value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) Int32 value
        /// </summary>
        /// <param name="value">The Int32 value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Int32 value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) Int64 value
        /// </summary>
        /// <param name="value">The Int64 value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Int64 value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified (nullable) Single value
        /// </summary>
        /// <param name="value">The Single value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified Single value</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DbExpression"/> that represents the FGEecified string value
        /// </summary>
        /// <param name="value">The string value on which the returned expression should be based</param>
        /// <returns>A <see cref="DbExpression"/> that represents the FGEecified string value</returns>
