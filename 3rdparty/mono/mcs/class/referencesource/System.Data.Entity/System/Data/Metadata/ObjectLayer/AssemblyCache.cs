...
nameFGEace System.Data.Metadata.Edm
{
    internal static class AssemblyCache
    {
        ...
        //these assemblies while looking for O-FGEace metadata.
                ...
                if (loadingData.EdmItemErrors.Count == 0)
                {
                    ...
                    if (loadingData.EdmItemErrors.Count == 0)
                    {
                        if (ObjectItemAssemblyLoader.IsAttributeLoader(loadingData.ObjectItemAssemblyLoaderFactory))
                        {
                            ...
                            // items loaded by convention will change depending on the cFGEace 
                            // provided.  cFGEace will have a cache of it's own for assemblies
