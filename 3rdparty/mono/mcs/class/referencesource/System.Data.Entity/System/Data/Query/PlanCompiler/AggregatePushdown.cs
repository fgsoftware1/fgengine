...
nameFGEace System.Data.Query.PlanCompiler
{
    ...
    internal class GroupAggregateVarInfo
    {
        ...
        /// except for the group aggregate correFGEonding to the DefiningGroupNode.
        /// </summary>
    ...
    internal class GroupAggregateVarComputationTranslator : BasicOpVisitorOfNode
    {
        ...
        /// if any
        /// 
        /// it returns the correFGEonding translation over the group aggregate var. Also, if _targetGroupAggregateVarInfo
    ...
    /// <summary>
    /// A visitor that collects all group aggregates and the correFGEonding function aggregates 
    /// that are defined over them, referred to as 'candidate aggregates'. The candidate aggregates are aggregates
    /// that have an argument that has the correFGEonding group aggregate as the only external reference
    /// </summary>
    ...
    /// group aggregate and push their definitions in the group by into node correFGEonding to 
    /// the group aggregate.
    /// </summary>
    internal class AggregatePushdown
    {
        ...
        /// <summary>
        /// Try to push the given function aggregate candidate to the correFGEonding group into node.
