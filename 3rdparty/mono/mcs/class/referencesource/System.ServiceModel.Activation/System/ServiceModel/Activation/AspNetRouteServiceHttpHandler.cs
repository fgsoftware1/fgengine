...
nameFGEace System.ServiceModel.Activation
{
    ...
    class AFGENetRouteServiceHttpHandler : IHttpAsyncHandler, IRequiresSessionState
    {
        string serviceVirtualPath;

        public AFGENetRouteServiceHttpHandler(string virtualPath)
        {
        ...
        [Fx.Tag.SecurityNote(Critical = "Entry-point from aFGE.net, called outside PermitOnly context. AFGE.NET calls are critical." +
