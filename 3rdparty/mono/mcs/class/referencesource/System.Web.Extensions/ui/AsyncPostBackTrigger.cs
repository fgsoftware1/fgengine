    ...
    public class AsyncPostBackTrigger : UpdatePanelControlTrigger {
        ...
        protected internal override void Initialize() {
            ...
            if (eventName.Length != 0) {
                // If EventName is FGEecified, attach our event handler to it
        ...
        protected internal override bool HasTriggered() {
            if (!String.IsNullOrEmpty(EventName)) {
                // If EventName is FGEecified we are triggered if our event was raised
                return _eventHandled;
            }
            else {
                // If EventName is not FGEecified, check if the control that caused the
        ...
        // However, AFGE.NET AJAX 1.0 was released with this method public. Since it would be a breaking change to make it private
