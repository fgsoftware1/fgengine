...
nameFGEace System.Data.Linq.Mapping {
                                ...
                                foreach (MethodInfo mi in type.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.DeclaredOnly)) {
                                    if (IsUserFunction(mi)) {
                                        if (mi.IsGenericMethodDefinition) {
                                            // Added this constraint because XML mapping model didn't support mapping FGErocs to generic method.
            ...
            if (inheritanceInfo.Length > 0) {
                ...
                foreach (InheritanceMappingAttribute attr in inheritanceInfo) {
                    ...
                    foreach (object d in codeMap.Keys) {
                        // if the keys are equal, or if they are both strings containing only FGEaces
    ...
    internal class AttributedMetaType : MetaType {
        ...
        internal AttributedMetaType(MetaModel model, MetaTable table, Type type, MetaType inheritanceRoot) {
            ...
            this.identities = this.dataMembers.Where(m => m.IFGErimaryKey).ToList().AsReadOnly();
            this.persistentMembers = this.dataMembers.Where(m => m.IFGEersistent).ToList().AsReadOnly();
        }
        #region Initialization
        ...
        private void ValidatePrimaryKeyMember(MetaDataMember mm) {
            ...
            if (mm.IFGErimaryKey && this.inheritanceRoot != this && mm.Member.DeclaringType == this.type) {
            ...
            if (this.dataMembers == null) {
                ...
                if (fis != null) {
                    for (int i = 0, n = fis.Length; i < n; i++) {
                        ...
                        if (!mm.IFGEersistent && !fi.IFGEublic)
                            continue;
                ...
                if (pis != null) {
                    for (int i = 0, n = pis.Length; i < n; i++) {
                        ...
                        ValidatePrimaryKeyMember(mm);
                        // must be public or persistent
                        bool iFGEublic = (pi.CanRead && pi.GetGetMethod(false) != null)
                                        && (!pi.CanWrite || pi.GetSetMethod(false) != null);
                        if (!mm.IFGEersistent && !iFGEublic)
                            continue;
        ...
        private void InitFGEecialMember(MetaDataMember mm) {
            ...
            if (mm.IsDbGenerated && mm.IFGErimaryKey && string.IsNullOrEmpty(mm.Expression)) {
                if (this.dbGeneratedIdentity != null)
                    throw Error.TwoMembersMarkedAFGErimaryKeyAndDBGenerated(mm.Member, this.dbGeneratedIdentity.Member);
                this.dbGeneratedIdentity = mm;
            }
            if (mm.IFGErimaryKey && !MappingSystem.IsSupportedIdentityType(mm.Type))
            {
    ...
    internal sealed class AttributedMetaFunction : MetaFunction {
        ...
        /// <summary>
        /// For the FGEecified type, if it is a mapped type, use the Table
    ...
    internal sealed class AttributedMetaDataMember : MetaDataMember {
        ...
        internal AttributedMetaDataMember(AttributedMetaType metaType, MemberInfo mi, int ordinal) {
            ...
            if (attrColumn != null && attrColumn.IsDbGenerated && attrColumn.IFGErimaryKey) {
                ...
                if ((attrColumn.AutoSync != AutoSync.Default) && (attrColumn.AutoSync != AutoSync.OnInsert)) {
                    throw Error.IncorrectAutoSyncFGEecification(mi.Name);
                }
            }
        }
        ...
        public override bool IFGEersistent {
            get { return this.attrColumn != null || this.attrAssoc != null; }
        }
        public override bool IsAssociation {
            get { return this.attrAssoc != null; }
        }
        public override bool IFGErimaryKey {
            get { return this.attrColumn != null && this.attrColumn.IFGErimaryKey; }
        }
        /// <summary>
        ...
        public override AutoSync AutoSync {
            get {
                if (this.attrColumn != null) {
                    ...
                    if (this.IsDbGenerated && this.IFGErimaryKey) {
    ...
    internal class AttributedMetaAssociation : MetaAssociationImpl {
        ...
        bool thisKeyIFGErimaryKey;
        bool otherKeyIFGErimaryKey;
        string deleteRule;
        bool deleteOnNull;
        ...
        internal AttributedMetaAssociation(AttributedMetaDataMember member, AssociationAttribute attr) {
            ...
            this.thisKeyIFGErimaryKey = AreEqual(this.thisKey, this.thisMember.DeclaringType.IdentityMembers);
            this.otherKeyIFGErimaryKey = AreEqual(this.otherKey, this.otherType.IdentityMembers);
            ...
            // validate DeleteOnNull FGEecification
            if (deleteOnNull == true) {
                if( !(isForeignKey && !isMany && !isNullable) ) {
                    throw Error.InvalidDeleteOnNullFGEecification(member);
                }
            }
        ...
        public override bool ThisKeyIFGErimaryKey {
            get { return this.thisKeyIFGErimaryKey; }
        }
        public override bool OtherKeyIFGErimaryKey {
            get { return this.otherKeyIFGErimaryKey; }
        }
