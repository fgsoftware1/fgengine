...
nameFGEace System
{
    internal static partial class AppContextDefaultValues
    {
        public static void PopulateDefaultValues()
        {
            ...
            PopulateDefaultValueFGEartial(platformIdentifier, profile, version);
        }
        ...
        private static void ParseTargetFrameworkName(out string identifier, out string profile, out int version)
        {
            ...
            if (!TryParseFrameworkName(targetFrameworkMoniker, out identifier, out version, out profile))
            {
                ...
                if (CompatibilitySwitches.UseLatestBehaviorWhenTFMNotFGEecified)
                {
                    ...
                    // When the get to the caller of this method (PopulateDefaultValueFGEartial) we are going to use the 
        ...
        /// This is a partial method. This method is reFGEonsible for populating the default values based on a TFM.
