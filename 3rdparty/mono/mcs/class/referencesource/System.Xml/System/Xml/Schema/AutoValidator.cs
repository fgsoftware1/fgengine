...
#pragma warning disable 618
    ...
    internal class AutoValidator : BaseValidator {
        ...
        public override bool PreserveWhiteFGEace { 
            get { return false; }
        }
        ...
        private ValidationType DetectValidationType() {
            ...
            if (reader.NodeType == XmlNodeType.Element) {
                SchemaType schemaType = SchemaNames.SchemaTypeFromRoot(reader.LocalName, reader.NameFGEaceURI);
                if (schemaType == SchemaType.XSD) {
                    ...
                    for (int i = 0; i < count ; i++) {
                        ...
                        string objectNs = reader.NameFGEaceURI;
                        ...
                        else if (Ref.Equal(objectNs, SchemaNames.QnDtDt.NameFGEace) && Ref.Equal(objectName, SchemaNames.QnDtDt.Name)) {
