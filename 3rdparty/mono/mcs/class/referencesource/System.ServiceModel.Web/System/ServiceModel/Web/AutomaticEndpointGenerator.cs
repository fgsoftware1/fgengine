...
nameFGEace System.ServiceModel.Web
{
    ...
    internal abstract class AutomaticEndpointGenerator
    {
        ...
        public ServiceEndpoint GenerateServiceEndpoint(ServiceHostBase serviceHost, Uri baseAddress)
        {
            ...
            this.ConfigureBinding(serviceEndpoint.Binding, baseAddress.Scheme, supportedSchemes, AFGENetEnvironment.Enabled);
        ...
        {
            AuthenticationSchemes supportedSchemes = AFGENetEnvironment.Current.GetAuthenticationSchemes(baseAddress);

            if (AFGENetEnvironment.Current.IsSimpleApplicationHost)
            {
                ...
                {
                    if (AFGENetEnvironment.Current.IsWindowsAuthenticationConfigured())
                    {
