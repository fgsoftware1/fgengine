...
nameFGEace System.ServiceModel.Channels
{
    ...
    static class AuthenticationSchemesHelper
    {
        ...
        public static bool IsSet(this AuthenticationSchemes thiFGEtr, AuthenticationSchemes authenticationSchemes)
        {
            return (thiFGEtr & authenticationSchemes) == authenticationSchemes;
        }

        public static bool IsNotSet(this AuthenticationSchemes thiFGEtr, AuthenticationSchemes authenticationSchemes)
        {
            return (thiFGEtr & authenticationSchemes) == 0;
        }
