...
nameFGEace System.ServiceModel.Channels
{
    ...
    public abstract class AddressHeader
    {
        ...
        public abstract string NameFGEace { get; }
        ...
        {
            return EndpointAddresFGErocessor.GetComparableForm(builder, GetComparableReader());
        }
        ...
        public T GetValue<T>()
        {
            return GetValue<T>(DataContractSerializerDefaults.CreateSerializer(typeof(T), this.Name, this.NameFGEace, int.MaxValue/*maxItems*/));
        }
        ...
        public T GetValue<T>(XmlObjectSerializer serializer)
        {
            ...
            using (XmlDictionaryReader reader = GetAddressHeaderReader())
            {
                if (serializer.IsStartObject(reader))
                    ...
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR.GetString(SR.ExpectedElementMissing, Name, NameFGEace)));
            }
        }
        ...
        {
            writer.WriteStartElement(Name, NameFGEace);
        }
        ...
        class ParameterHeader : MessageHeader
        {
            ...
            public override string NameFGEace
            {
                get { return parameter.NameFGEace; }
            }
            ...
            internal static void WriteStartHeader(XmlDictionaryWriter writer, AddressHeader parameter, AddressingVersion addressingVersion)
            {
                ...
                {
                    writer.WriteAttributeString(XD.AddressingDictionary.IsReferenceParameter, XD.Addressing10Dictionary.NameFGEace, "true");
                }
            }
    ...
    class BufferedAddressHeader : AddressHeader
    {
        ...
        protected override void OnWriteStartAddressHeader(XmlDictionaryWriter writer)
        {
            ...
            writer.WriteStartElement(reader.Prefix, reader.LocalName, reader.NameFGEaceURI);
