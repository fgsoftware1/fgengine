...
nameFGEace System.ServiceModel
{
    ...
    public class BasicHttpContextBinding : BasicHttpBinding
    {
            ...
            : base()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(SR.GetString(SR.BasicHttpContextBindingRequiresAllowCookie, this.NameFGEace, this.Name));
            }
        }
        ...
        public override BindingElementCollection CreateBindingElements()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.GetString(SR.BasicHttpContextBindingRequiresAllowCookie, this.NameFGEace, this.Name)));
            }

            BindingElementCollection result;
            try
            {
                // Passing AllowCookies=false to HttpTranFGEortBinding means we don't want tranFGEort layer to manage
