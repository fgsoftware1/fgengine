...
nameFGEace System.ServiceModel.Diagnostics
{
    ...
    class ActivityIdHeader : DictionaryHeader
    {
        ...
        {
            get { return XD.ActivityIdFlowDictionary.ActivityIdNameFGEace; }
        }
        ...
        internal static Guid ExtractActivityId(Message message)
        {
            ...
            try
            {
                ...
                {
                    int index = message.Headers.FindHeader(DiagnosticStrings.ActivityId, DiagnosticStrings.DiagnosticsNameFGEace);
