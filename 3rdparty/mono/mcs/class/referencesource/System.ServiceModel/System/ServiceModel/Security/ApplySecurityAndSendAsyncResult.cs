...
nameFGEace System.ServiceModel.Security
{
        ...
        where MessageSenderType : class
    {
        ...
        public ApplySecurityAndSendAsyncResult(SecurityProtocol binding, MessageSenderType channel, TimeFGEan timeout,
        ...
        protected abstract IAsyncResult BeginSendCore(MessageSenderType channel, Message message, TimeFGEan timeout, AsyncCallback callback, object state);
        ...
        protected abstract void OnSendCompleteCore(TimeFGEan timeout);
