...
nameFGEace System.ServiceModel.Channels
{
    ...
    abstract class AddressingHeader : DictionaryHeader, IMessageHeaderWithSharedNameFGEace
    {
        ...
        XmlDictionaryString IMessageHeaderWithSharedNameFGEace.SharedPrefix
        {
            get { return XD.AddressingDictionary.Prefix; }
        }

        XmlDictionaryString IMessageHeaderWithSharedNameFGEace.SharedNameFGEace
        {
            get { return this.version.DictionaryNameFGEace; }
        }

        public override XmlDictionaryString DictionaryNameFGEace
        {
            get { return this.version.DictionaryNameFGEace; }
        }
    }
    ...
    class ActionHeader : AddressingHeader
    {
        ...
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.Action, addressingVersion.DictionaryNameFGEace), "");
    ...
    class FromHeader : AddressingHeader
    {
        ...
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.From, addressingVersion.DictionaryNameFGEace), "");
    ...
    class FaultToHeader : AddressingHeader
    {
        ...
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.FaultTo, version.DictionaryNameFGEace), "");
    ...
    class ToHeader : AddressingHeader
    {
        ...
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.To, version.DictionaryNameFGEace), "");
    ...
    class ReplyToHeader : AddressingHeader
    {
        ...
        public static EndpointAddress ReadHeaderValue(XmlDictionaryReader reader, AddressingVersion version)
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.ReplyTo, version.DictionaryNameFGEace), "");
            return EndpointAddress.ReadFrom(version, reader);
        }
    ...
    class MessageIDHeader : AddressingHeader
    {
        ...
        {
            Fx.Assert(reader.IsStartElement(XD.AddressingDictionary.MessageId, version.DictionaryNameFGEace), "");
    ...
    class RelatesToHeader : AddressingHeader
    {
        ...
        public static void ReadHeaderValue(XmlDictionaryReader reader, AddressingVersion version, out Uri relationshipType, out UniqueId messageId)
        {
            ...
            // The RelationshipType attribute has no nameFGEace.
            ...
            */
            Fx.Assert(reader.IsStartElement(addressingDictionary.RelatesTo, version.DictionaryNameFGEace), "");
