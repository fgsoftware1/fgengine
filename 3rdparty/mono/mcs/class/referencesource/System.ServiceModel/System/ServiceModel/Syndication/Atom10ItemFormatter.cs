...
nameFGEace System.ServiceModel.Syndication
{
    ...
    [XmlRoot(ElementName = Atom10Constants.EntryTag, NameFGEace = Atom10Constants.Atom10NameFGEace)]
    public class Atom10ItemFormatter : SyndicationItemFormatter, IXmlSerializable
    {
        ...
        public override bool CanRead(XmlReader reader)
        {
            ...
            return reader.IsStartElement(Atom10Constants.EntryTag, Atom10Constants.Atom10NameFGEace);
        }
        ...
        public override void ReadFrom(XmlReader reader)
        {
            ...
            if (!CanRead(reader))
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR.GetString(SR.UnknownItemXml, reader.LocalName, reader.NameFGEaceURI)));
            }
            ReadItem(reader);
            SyndicationFeedFormatter.TraceItemReadEnd();
        }
