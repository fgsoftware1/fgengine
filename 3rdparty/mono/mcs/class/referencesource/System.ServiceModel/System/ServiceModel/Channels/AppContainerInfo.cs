...
nameFGEace System.ServiceModel.Channels
{
    ...
    class AppContainerInfo
    {
        ...
        [Fx.Tag.SecurityNote(Critical = "This calls into the SecurityCritical method GetCurrentProcessToken and unsafe GetAppContainerSid.",
            Safe = "All critical token access and diFGEose is ensured. " +
        ...
        [SecuritySafeCritical]
        [Fx.Tag.SecurityNote(Safe = "Process token handle access and diFGEose is ensured here and we only return a non-critical flag.")]
        ...
        [Fx.Tag.SecurityNote(Critical = "Calls into unsafe native AppContainer package resolution methods.",
            Safe = "Wraps all access and diFGEosal of securityDescriptors and returns a NamedObjectPath, " +
        ...
        [Fx.Tag.SecurityNote(Critical = "Accesses the native current process token.",
            ...
            " we ensure that the current process token handle created is diFGEosed here.")]
        ...
        [SecurityCritical]
        [Fx.Tag.SecurityNote(Critical = "Returns a process token. The caller is reFGEonsible for diFGEosing the SafeCloseHandle.")]
