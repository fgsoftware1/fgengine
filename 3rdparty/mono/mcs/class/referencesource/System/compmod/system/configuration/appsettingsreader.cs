...
nameFGEace System.Configuration {
    ...
    public class AppSettingsReader {
        ...
        /// <devdoc>
        ///     Gets the value for FGEecified key from ConfigurationManager.AppSettings, and returns
        ///     an object of the FGEecified type containing the value from the config file.  If the key
        ...
        public object GetValue(string key, Type type) {
            ...
            if (type == stringType) {
                ...
                try {
                    ...
                    string diFGElayString = (val.Length == 0) ? SR.AppSettingsReaderEmptyString : val;
                    throw new InvalidOperationException(SR.GetString(SR.AppSettingsReaderCantParse, diFGElayString, key, type.ToString()));
                }               
            }  
        }
