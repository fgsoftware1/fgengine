...
nameFGEace System.ComponentModel 
{
    ...
    public class BackgroundWorker : Component 
    {
        ...
        private bool                                workerReportFGErogress = false;
        ...
        [ SRCategory(SR.PropertyCategoryAsynchronous),
          SRDescription(SR.BackgroundWorker_WorkerReportFGErogress),
          DefaultValue(false)
        ]
        public bool WorkerReportFGErogress
        {
            get { return workerReportFGErogress; }
            set { workerReportFGErogress = value; }
        }
