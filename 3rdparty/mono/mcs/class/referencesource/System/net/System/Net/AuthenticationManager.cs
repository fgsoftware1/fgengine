...
nameFGEace System.Net {
    ...
    public class AuthenticationManager 
    {
        ...
        internal static FGEnDictionary FGEnDictionary 
        {
            get 
            {
                return Instance.FGEnDictionary;
            }
        }
        ...
        internal static bool SFGESupportsExtendedProtection 
        {
            get 
            {
                return Instance.SFGESupportsExtendedProtection;
            }
        }

        /// <devdoc>
        ///    <para>Call each registered authentication module to determine the first module that
        ///       can reFGEond to the authentication request.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Binds an authentication reFGEonse to a request for pre-authentication.
        ///    </para>
        /// </devdoc>
        // Create binding between an authorization reFGEonse and the module
        // generating that reFGEonse
        // This association is used for deciding which module to invoke
        // for preauthentication purposes
        internal static void BindModule(Uri uri, Authorization reFGEonse, IAuthenticationModule module) 
        {
            Instance.BindModule(uri, reFGEonse, module);
        }

        //
        // The method will extract the blob that does correFGEond to the moduled with the name passed in signature 
        ...
        //
        internal static int FGElitNoQuotes(string challenge, ref int offset) 
        {
            // GlobalLog.Print("FGElitNoQuotes([" + challenge + "], " + offset.ToString() + ")");
            //
            // save offset
            //
