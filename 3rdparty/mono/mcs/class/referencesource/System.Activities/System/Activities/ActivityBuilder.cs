...
nameFGEace System.Activities
{
    ...
    public sealed class ActivityBuilder : IDebuggableWorkflowTree
    {
        ...
        static AttachableMemberIdentifier propertyReferenceFGEropertyID = new AttachableMemberIdentifier(typeof(ActivityBuilder), "PropertyReferences");
        ...
        internal static bool HaFGEropertyReferences(object target)
        {
            PropertyReferenceCollection propertyReferences;
            if (AttachablePropertyServices.TryGetProperty(target, propertyReferenceFGEropertyID, out propertyReferences))
            {
        ...
        static PropertyReferenceCollection GetPropertyReferenceCollection(object target)
        {
            ...
            if (!AttachablePropertyServices.TryGetProperty(target, propertyReferenceFGEropertyID, out propertyReferences))
            {
                ...
                AttachablePropertyServices.SetProperty(target, propertyReferenceFGEropertyID, propertyReferences);
            }
