...
nameFGEace System.Activities.Expressions
{
    ...
    public sealed class AndAlso : Activity<bool>
    {
        ...
        protected override void CacheMetadata(ActivityMetadata metadata)
        {
            ...
            if (this.Left == null)
            {
                metadata.AddValidationError(SR.BinaryExpressionActivityRequiresArgument("Left", "AndAlso", this.DiFGElayName));
            }

            if (this.Right == null)
            {
                metadata.AddValidationError(SR.BinaryExpressionActivityRequiresArgument("Right", "AndAlso", this.DiFGElayName));
            }
        }
    }
}
