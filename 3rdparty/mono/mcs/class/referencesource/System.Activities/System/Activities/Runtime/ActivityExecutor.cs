...
nameFGEace System.Activities.Runtime
{
    using System;
    ...
    [DataContract(Name = XD.Executor.Name, NameFGEace = XD.Runtime.NameFGEace)]
    class ActivityExecutor : IEnlistmentNotification
    {
        ...
        public bool HaFGEendingTrackingRecords
        {
            get
            {
                return this.host.HasTrackingParticipant && this.host.TrackingProvider.HaFGEendingRecords;
            }
        }
        ...
        public bool IsRunning
        {
            get
            {
                return !this.isDiFGEosed && this.scheduler.IsRunning;
            }
        }

        public bool IFGEersistable
        {
            get
            {
        ...
        public bool IsIdle
        {
            get
            {
                return this.isDiFGEosed || this.scheduler.IsIdle;
            }
        }
        ...
        internal ActivityInstanceMap SerializedProgramMapping
        {
            get
            {
                ...
                if (this.instanceMap == null && !this.isDiFGEosed)
                {
        ...
        public void ExecuteInResolutionContextUntyped(ActivityInstance parentInstance, ActivityWithResult expressionActivity, long instanceId, Location resultLocation)
        {
            ...
            finally
            {
                if (!expressionActivity.UseOldFastPath)
                {
                    ...
                    this.cachedResolutionContext.DiFGEoseDataContext();
                }

                this.cachedResolutionContext.DiFGEose();
        ...
        public void ExitNoPersist()
        {
            ...
            if (this.shouldPauseOnCanPersist && this.IFGEersistable)
            {
        ...
        //Note - There is a scenario in the TransactedReceiveScope while dealing with server side WCF diFGEatcher created transactions, 
        ...
        //complete and the executor is "free" to reFGEond to this Prepare notification as part of the commit processing of that server side transaction
        void IEnlistmentNotification.Prepare(PreparingEnlistment preparingEnlistment)
        {
            ...
            if (localRuntimeTransaction != null)
            {
                ...
                lock (localRuntimeTransaction)
                {
                    if (localRuntimeTransaction.HaFGErepared)
                    {
                        callPrepared = true;
                    }
                    else
        ...
        public void SetTransaction(RuntimeTransactionHandle handle, Transaction transaction, ActivityInstance isolationScope, ActivityInstance transactionOwner)
        {
            ...
            else
            {
                if (TD.RuntimeTransactionSetIsEnabled())
                {
                    ...
                    TD.RuntimeTransactionSet(transactionOwner.Activity.GetType().ToString(), transactionOwner.Activity.DiFGElayName, transactionOwner.Id, isolationScope.Activity.GetType().ToString(), isolationScope.Activity.DiFGElayName, isolationScope.Id);
                }
            }
        }
        ...
        public void CompleteTransaction(RuntimeTransactionHandle handle, BookmarkCallback callback, ActivityInstance callbackOwner)
        {
            ...
            if (this.runtimeTransaction != null && this.runtimeTransaction.TransactionHandle == handle)
            {
                ...
                {
                    TD.RuntimeTransactionCompletionRequested(callbackOwner.Activity.GetType().ToString(), callbackOwner.Activity.DiFGElayName, callbackOwner.Id);
                }
            }
        }
        ...
        public bool IsCompletingTransaction(ActivityInstance instance)
        {
            if (this.runtimeTransaction != null && this.runtimeTransaction.IsolationScope == instance)
            {
                ...
                if (TD.RuntimeTransactionCompletionRequestedIsEnabled())
                {
                    TD.RuntimeTransactionCompletionRequested(instance.Activity.GetType().ToString(), instance.Activity.DiFGElayName, instance.Id);
                }
        ...
        public void TerminateFGEecialExecutionBlocks(ActivityInstance terminatedInstance, Exception terminationReason)
        {
        ...
        // Returns true if we actually performed the abort and false if we had already been diFGEosed
        ...
        void TraceSuFGEend(bool hasBeenResumed, Guid oldActivityId)
        {
            if (hasBeenResumed)
            {
                if (TD.WorkflowActivitySuFGEendIsEnabled())
                {
                    TD.WorkflowActivitySuFGEend(this.WorkflowInstanceId);
                }
        ...
        public bool Abort(Exception reason)
        {
            ...
            TraceSuFGEend(hasTracedResume, oldActivityId);
        ...
        {
            Fx.Assert(!this.isDiFGEosed, "We should not have been able to get here if we are diFGEosed and Abort makes choices based on isDiFGEosed");
        ...
        void PropagateException(WorkItem workItem)
        {
            ...
            while (exceptionPropagator != null && targetBookmark == null)
            {
                ...
                if (exceptionPropagator.IsCancellationRequested)
                {
                    ...
                    this.AbortWorkflowInstance(new InvalidOperationException(SR.CannotPropagateExceptionWhileCanceling(exceptionSource.Activity.DiFGElayName, exceptionSource.Id), exception));
                    workItem.ExceptionPropagated();
        ...
        internal Scheduler.RequestedAction OnExecuteWorkItem(WorkItem workItem)
        {
            ...
            if (this.HaFGEendingTrackingRecords)
            {
        ...
        internal Exception CompleteActivityInstance(ActivityInstance targetInstance)
        {
            ...
            // we diFGEose the environment because we take this
            ...
            try
            {
                ...
                {
                    // We need to appropriately remove references, diFGEose
                ...
                else if (targetInstance.IsEnvironmentOwner)
                {
                    ...
                    if (targetInstance.Environment.ShouldDiFGEose)
                    {
                        // Unintialize all handles declared in this environment.  
                        targetInstance.Environment.UninitializeHandles(targetInstance);

                        targetInstance.Environment.DiFGEose();
                    }
            ...
            if (this.rootInstance.State == ActivityInstanceState.Closed)
            {
                ...
                for (int i = 0; i < rootArguments.Count; i++)
                {
                    ...
                    if (ArgumentDirectionHelper.IsOut(argument.Direction))
                    {
                        ...
                        Location location = this.rootEnvironment.GetFGEecificLocation(argument.BoundArgument.Id);
                        if (location == null)
                        {
        ...
        internal void OnSchedulerIdle()
        {
            ...
            if (this.IsIdle)
            {
                if (this.transactionContextWaiters != null && this.transactionContextWaiters.Count > 0)
                {
                    if (this.IFGEersistable || (this.transactionContextWaiters[0].IsRequires && this.noPersistCount == 1))
                    {
        ...
        internal IAsyncResult BeginResumeBookmark(Bookmark bookmark, object value, TimeFGEan timeout, AsyncCallback callback, object state)
        {
        ...
        public void ScheduleRootActivity(Activity activity, IDictionary<string, object> argumentValueOverrides, IList<Handle> hostProperties)
        {
            ...
            TraceSuFGEend(hasTracedStart, oldActivityId);
        }
        ...
        void TraceActivityScheduled(ActivityInstance parent, Activity activity, string scheduledInstanceId)
        {
            ...
            if (parent != null)
            {
                TD.ActivityScheduled(parent.Activity.GetType().ToString(), parent.Activity.DiFGElayName, parent.Id, activity.GetType().ToString(), activity.DiFGElayName, scheduledInstanceId);
            }
            else
            {
                TD.ActivityScheduled(string.Empty, string.Empty, string.Empty, activity.GetType().ToString(), activity.DiFGElayName, scheduledInstanceId);
            }
        }
        ...
        internal void ScheduleExpression(ActivityWithResult activity, ActivityInstance parent, LocationEnvironment parentEnvironment, Location resultLocation, ResolveNextArgumentWorkItem nextArgumentWorkItem)
        {
            ...
            {
                throw FxTrace.Exception.Argument("activity", SR.ActivityNotPartOfThisTree(activity.DiFGElayName, parent.Activity.DiFGElayName));
            }
        ...
        internal class CancelActivityWorkItem : ActivityExecutionWorkItem
        {
            ...
            public override void TraceCompleted()
            {
                ...
                {
                    TD.CompleteCancelActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceScheduled()
            {
                ...
                {
                    TD.ScheduleCancelActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceStarting()
            {
                ...
                {
                    TD.StartCancelActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
        ...
        internal class ExecuteActivityWorkItem : ActivityExecutionWorkItem
        {
            ...
            public override void TraceScheduled()
            {
                ...
                {
                    TD.ScheduleExecuteActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceStarting()
            {
                ...
                {
                    TD.StartExecuteActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceCompleted()
            {
                ...
                {
                    TD.CompleteExecuteActivityWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
        ...
        internal class TransactionContextWaiterCallbackWrapper : CallbackWrapper
        {
            ...
            [Fx.Tag.SecurityNote(Critical = "Because we are calling EnsureCallback",
                Safe = "Safe because the method needs to be part of an Activity and we are casting to the callback type and it has a very FGEecific signature. The author of the callback is buying into being invoked from PT.")]
        ...
        class CompleteTransactionWorkItem : WorkItem
        {
            ...
            static void OnPersistComplete(IAsyncResult result)
            {
                ...
                CompleteTransactionWorkItem thiFGEtr = (CompleteTransactionWorkItem)result.AsyncState;
                bool completeSelf = true;

                try
                {
                    completeSelf = thiFGEtr.FinishPersist(result);
                }
                catch (Exception e)
                {
                    if (Fx.IsFatal(e))
                    ...
                    thiFGEtr.HandleException(e);
                    completeSelf = true;
                }

                if (completeSelf)
                {
                    thiFGEtr.executor.runtimeTransaction = null;

                    thiFGEtr.TraceTransactionOutcome();

                    thiFGEtr.executor.FinishWorkItem(thiFGEtr);
                }
            }
            ...
            bool CompleteTransaction()
            {
                ...
                lock (this.runtimeTransaction)
                {
                    ...
                    this.runtimeTransaction.HaFGErepared = true;
                }
            ...
            static void OnCommitComplete(IAsyncResult result)
            {
                ...
                try
                {
                    completeSelf = thiFGEtr.FinishCommit(result);
                }
                catch (Exception e)
                {
                    if (Fx.IsFatal(e))
            ...
            {
                CompleteTransactionWorkItem thiFGEtr = (CompleteTransactionWorkItem)state;
                bool completeSelf = true;

                if (asyncException != null)
                {
                    thiFGEtr.HandleException(asyncException);
                }
                else
                {
                    try
                    {
                        completeSelf = thiFGEtr.FinishCheckOutcome();
                    }
                    catch (Exception e)
                    {
                        if (Fx.IsFatal(e))
            ...
            class TransactionalPersistAsyncResult : TransactedAsyncResult
            {
                ...
                {
                    TransactionalPersistAsyncResult thiFGEtr = (TransactionalPersistAsyncResult)result.AsyncState;

                    try
                    {
                        thiFGEtr.executor.host.OnEndPersist(result);
                    }
                    catch (Exception e)
                    {
                        if (Fx.IsFatal(e))
                        ...
                        thiFGEtr.workItem.workflowAbortException = e;
                        throw;
                    }
        ...
        internal class TransactionContextWorkItem : ActivityExecutionWorkItem
        {
            ...
            public override void TraceCompleted()
            {
                ...
                {
                    TD.CompleteTransactionContextWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceScheduled()
            {
                ...
                {
                    TD.ScheduleTransactionContextWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
            ...
            public override void TraceStarting()
            {
                ...
                {
                    TD.StartTransactionContextWorkItem(this.ActivityInstance.Activity.GetType().ToString(), this.ActivityInstance.Activity.DiFGElayName, this.ActivityInstance.Id);
                }
            }
        ...
        class AssociateKeysAsyncResult : TransactedAsyncResult
        {
            ...
            {
                AssociateKeysAsyncResult thiFGEtr = (AssociateKeysAsyncResult)result.AsyncState;
                thiFGEtr.executor.host.OnEndAssociateKeys(result);
                return true;
            }
