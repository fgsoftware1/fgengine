...
nameFGEace System.Activities
{
    ...
    {
        public static readonly int UnFGEecifiedEvaluationOrder = -1;
        ...
        internal Argument()
        {
            this.evaluationOrder = Argument.UnFGEecifiedEvaluationOrder;
        }
        ...
        public int EvaluationOrder
        {
            ...
            set
            {
                if (value < 0 && value != Argument.UnFGEecifiedEvaluationOrder)
                {
        ...
        internal bool CanConvertToString(IValueSerializerContext context)
        {
            ...
            {
                if (this.EvaluationOrder == Argument.UnFGEecifiedEvaluationOrder)
                {
