...
nameFGEace System.Activities.Statements
{
    using System;
    ...
    public sealed class AddToCollection<T> : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            if (collection == null)
            {
                throw FxTrace.Exception.AsError(new InvalidOperationException(SR.CollectionActivityRequiresCollection(this.DiFGElayName)));
            }
