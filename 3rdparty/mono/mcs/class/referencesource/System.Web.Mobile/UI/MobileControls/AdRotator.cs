...
nameFGEace System.Web.UI.MobileControls
{
     ...
     *
     * This class aggregates the correFGEonding AFGE.NET AdRotator for delegating
     ...
     * by setting the correFGEonding properties on the control.
     *
    ...
    [AFGENetHostingPermission(SecurityAction.LinkDemand, Level=AFGENetHostingPermissionLevel.Minimal)]
    [AFGENetHostingPermission(SecurityAction.InheritanceDemand, Level=AFGENetHostingPermissionLevel.Minimal)]
    ...
    public class AdRotator : MobileControl
    {
        ...
        /// <value>
        /// <para>
        /// The keyword used to identify advertisements within a FGEecific catagory.
        /// </para>
        /// </value>
        /// <remarks>
        /// <para>
        ...
        /// exists, a blank image is diFGElayed and a trace warning is generated.
        /// </para>
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            // Delegate FGEecific custom attribute to the child Image control
        ...
        private void WebAdCreated(Object sender, AdCreatedEventArgs e)
        {
            ...
            // AdProperties can be null when ad file is not FGEecified
            // correctly.
            ...
            // Then invoke user events for further manipulation FGEecified by
            // user
            OnAdCreated(e);
        ...
        // Helper function adopted from AFGE.NET AdRotator class (modified
        // slightly)
