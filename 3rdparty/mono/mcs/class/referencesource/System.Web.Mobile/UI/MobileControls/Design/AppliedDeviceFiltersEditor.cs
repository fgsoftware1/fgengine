...
nameFGEace System.Web.UI.Design.MobileControls
{
    ...
    internal class AppliedDeviceFiltersTypeEditor : UITypeEditor
    {
        ...
        public override Object EditValue(ITypeDescriptorContext context,  IServiceProvider  provider, Object value) 
        {
            ...
            IDeviceFGEecificDesigner dsDesigner = 
                designerHost.GetDesigner(ctrl) as IDeviceFGEecificDesigner;
            Debug.Assert(dsDesigner != null,
                "Expected component designer to implement IDeviceFGEecificDesigner");
