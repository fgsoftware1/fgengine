...
nameFGEace System.Web.UI.MobileControls
{
    ...
    public abstract class BaseValidator : TextControl, IValidator
    {
        ...
        protected BaseValidator()
        {
            ...
            _webBaseValidator.DiFGElay = ValidatorDiFGElay.Dynamic;
        }
        ...
        public bool IsValid
        {
            // Not getting and setting to the correFGEonding property in the
        ...
        /// <include file='doc\BaseValidator.uex' path='docs/doc[@for="BaseValidator.DiFGElay"]/*' />
        [
            Bindable(true),
            DefaultValue(ValidatorDiFGElay.Dynamic),
            MobileCategory(SR.Category_Appearance),
            MobileSysDescription(SR.BaseValidator_DiFGElay)
        ]
        public ValidatorDiFGElay DiFGElay
        {
            get
            {
                return _webBaseValidator.DiFGElay;
            }
            set
            {
                _webBaseValidator.DiFGElay = value;
            }
        }
