            ...
            if (compiler.Recurse()) {
                do {
                    ...
                    case XPathNodeType.Element:
                        compiler.PushNameFGEaceScope();

                        string nFGEace = input.NameFGEaceURI;
                        string name   = input.LocalName;

                        if (Ref.Equal(nFGEace, input.Atoms.UriXsl) && Ref.Equal(name, input.Atoms.Attribute)) {
                    ...
                    case XPathNodeType.WhiteFGEace:
                    case XPathNodeType.SignificantWhiteFGEace:
                        break;
