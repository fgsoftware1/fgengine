...
nameFGEace System.Web.Management {
    using System;
    ...
    internal class AppDomainResourcePerfCounters {
        ...
        private TimeFGEan  _TotalCPUTime;
        ...
        private void SetPerfCounters() {
            ...
            TimeFGEan newTotalCPUTime = AppDomain.CurrentDomain.MonitoringTotalProcessorTime;
