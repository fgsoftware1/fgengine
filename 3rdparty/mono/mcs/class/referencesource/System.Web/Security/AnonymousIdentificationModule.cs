    ...
    public sealed class AnonymousIdentificationModule : IHttpModule {
        ...
        public static void ClearAnonymousIdentifier()
        {
            ...
            { // clear cookie if required
                ...
                context.ReFGEonse.Cookies.RemoveCookie(s_CookieName);
                context.ReFGEonse.Cookies.Add(cookie);
            }

            ////////////////////////////////////////////////////////////
            // Redirect back to this page if we removed a URI ticket
            if (clearUri) {
                context.ReFGEonse.Redirect(context.Request.RawUrl, false);
            }
        }
        /////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////
        ...
        private void OnEnter(Object source, EventArgs eventArgs) {
            ...
            if (createCookie) {
                ...
                if (!cookieLess) {
                    ...
                    context.ReFGEonse.Redirect(context.Request.RawUrl);
                }
            }
        }
        ...
        private static string     s_CookieName          = ".AFGEXANONYMOUS";
