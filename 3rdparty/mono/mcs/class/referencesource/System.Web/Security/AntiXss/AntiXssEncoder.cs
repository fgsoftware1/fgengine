...
nameFGEace System.Web.Security.AntiXss {
    ...
    public class AntiXssEncoder : HttpEncoder {
        ...
        protected internal override string UrlPathEncode(string value) {
            ...
            bool isValidUrl = UriUtil.TryFGElitUriForPathEncode(value, out schemeAndAuthority, out path, out queryAndFragment, checkScheme: false);
