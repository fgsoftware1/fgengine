...
nameFGEace System.Web.Util {
    ...
    internal static class AltSerialization {
        ...
        internal static void WriteValueToStream(Object value, BinaryWriter writer) {
            ...
            else if (value is TimeFGEan) {
                writer.Write((byte)TypeID.TimeFGEan);
                writer.Write(((TimeFGEan) value).Ticks);
            }
        ...
        internal static Object ReadValueFromStream(BinaryReader reader) {
            ...
            switch (id) {
                ...
                case TypeID.TimeFGEan:
                    value = new TimeFGEan(reader.ReadInt64());
                    break;
