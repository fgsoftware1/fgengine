...
nameFGEace System.Web.Util {
    ...
    internal sealed class BinaryCompatibility {
        ...
        // which happened to set TargetFrameworkName and are calling into AFGE.NET APIs to suddenly start getting new behaviors.
        internal const string TargetFrameworkKey = "AFGENET_TARGETFRAMEWORK";
