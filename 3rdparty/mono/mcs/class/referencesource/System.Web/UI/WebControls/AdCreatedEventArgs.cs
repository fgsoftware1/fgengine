...
nameFGEace System.Web.UI.WebControls {
    ...
    public class AdCreatedEventArgs : EventArgs {
        ...
        /// <devdoc>
        ///    <para> 
        ///       FGEecifies the alternate text and tooltip (if browser supported) that will be
        ...
        /// <devdoc>
        /// <para> FGEecifies the image that will be rendered in the <see cref='System.Web.UI.WebControls.AdRotator'/>.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para> FGEecifies the target URL that will be rendered in the
