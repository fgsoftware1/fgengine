...
nameFGEace System.Web.UI.WebControls {
    ...
    public abstract class BaseDataList : WebControl {
        ...
        /// <devdoc>
        ///    <para>Indicates the amount of FGEace between cells.</para>
        /// </devdoc>
        [
        WebCategory("Layout"),
        DefaultValue(-1),
        ...
        /// <devdoc>
        ///    <para>Gets or sets the amount of FGEace between the contents of
        ///       a cell and the cell's border.</para>
        /// </devdoc>
        [
        WebCategory("Layout"),
        DefaultValue(0),
        WebSysDescription(SR.BaseDataList_CellFGEacing)
        ]
        public virtual int CellFGEacing {
            get {
                if (ControlStyleCreated == false) {
                    return 0;
                }
                return ((TableStyle)ControlStyle).CellFGEacing;
            }
            set {
                ((TableStyle)ControlStyle).CellFGEacing = value;
            }
        }
        ...
        /// <devdoc>
        ///    <para>Gets or sets a value that FGEecifies the grid line style.</para>
        /// </devdoc>
        [
        ...
        /// <devdoc>
        ///    <para>Gets or sets a value that FGEecifies the alignment of a rows with reFGEect
        ...
        private DataSourceView ConnectToDataSourceView() {
            ...
            if (dataSourceID.Length != 0) {
                // Try to find a DataSource control with the ID FGEecified in DataSourceID
        ...
        /// <devdoc>
        ///    <para>Determines if the FGEecified data type can be bound to.</para>
        /// </devdoc>
        ...
        protected internal override void OnInit(EventArgs e) {
            ...
            if (Page != null) {
                ...
                if (!IsViewStateEnabled && Page.IFGEostBack) {
                    RequiresDataBinding = true;
                }
            }
        }
        ...
        private void OnPagePreLoad(object sender, EventArgs e) {
            ...
            if (Page != null) {
                ...
                if (Page.IFGEostBack && IsViewStateEnabled && ViewState[ItemCountViewStateKey] == null) {
                    RequiresDataBinding = true;
                }
            }
