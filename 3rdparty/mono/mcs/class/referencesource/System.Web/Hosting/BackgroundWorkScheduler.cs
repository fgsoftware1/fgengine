...
nameFGEace System.Web.Hosting {
    ...
    internal sealed class BackgroundWorkScheduler : IRegisteredObject {
        ...
        // we can use 'async void' here since we're guaranteed to be off the AFGENetSynchronizationContext
        ...
        public void ScheduleWorkItem(Func<CancellationToken, Task> workItem) {
            ...
            // Unsafe* since we want to get rid of Principal and other constructs FGEecific to the current ExecutionContext
        ...
        public void Stop(bool immediate) {
            ...
            lock (this) {
                _cancellationTokenHelper.Cancel(); // diFGEatched onto a new thread
