...
nameFGEace System.Web.Hosting {
    ...
    internal abstract class AsyncResultBase : IAsyncResult {
        ...
        private volatile ExceptionDiFGEatchInfo _error;
        ...
        // method actually completed synchronously is to inFGEect which thread the callback was invoked on,
        ...
        internal void SetError(Exception error) {
            ...
            _error = ExceptionDiFGEatchInfo.Capture(error);
        }
        ...
        internal ExceptionDiFGEatchInfo Error { get { return _error; } }
