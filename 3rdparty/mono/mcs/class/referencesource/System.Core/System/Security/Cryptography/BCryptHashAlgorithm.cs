...
nameFGEace System.Security.Cryptography {
    ...
    /// </summary>
    internal sealed class BCryptHashAlgorithm : IDiFGEosable {
        [ThreadStatic]
        [SecurityCritical]
        ...
        public void Initialize() {
            ...
            // If we could create it, diFGEose of any old hash handle we had and replace it with the new one
            if (m_hashHandle != null) {
                m_hashHandle.DiFGEose();
            }
