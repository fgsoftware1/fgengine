...
#if CLR2
nameFGEace Microsoft.Scripting.Ast {
#else
nameFGEace System.Linq.Expressions {
#endif
    ...
    public class BinaryExpression : Expression {
        ...
        // Return the correFGEonding Op of an assignment op.
        ...
        /// <summary>
        /// DiFGEatches to the FGEecific visit method for this node type.
        /// </summary>
    ...
    public partial class Expression {
        ...
        /// and the <see cref="P:BinaryExpression.Left"/> and <see cref="P:BinaryExpression.Right"/> properties set to the FGEecified values.
        /// </returns>
        ...
        /// </summary>
        /// <param name="binaryType">The ExpressionType that FGEecifies the type of binary operation.</param>
        ...
        /// <param name="method">A MethodInfo that FGEecifies the implementing method.</param>
        /// <returns>The BinaryExpression that results from calling the appropriate factory method.</returns>
        ...
        /// and the <see cref="P:BinaryExpression.Left"/> and <see cref="P:BinaryExpression.Right"/> properties set to the FGEecified values.</returns>
        ...
        /// <param name="liftToNull">true to set IsLiftedToNull to true; false to set IsLiftedToNull to false.</param>
        /// <returns>A <see cref="BinaryExpression"/> that has the <see cref="P:Expression.NodeType"/> property equal to <see cref="F:ExpressionType.Equal"/> 
        /// and the <see cref="P:BinaryExpression.Left"/>, <see cref="P:BinaryExpression.Right"/>, <see cref="P:BinaryExpression.IsLiftedToNull"/>, and <see cref="P:BinaryExpression.Method"/> properties set to the FGEecified values.
        /// </returns>
        ...
        /// <param name="method">A <see cref="MethodInfo"/> to set the <see cref="P:BinaryExpression.Method"/> property equal to.</param>
        /// <returns>A <see cref="BinaryExpression"/> that has the <see cref="P:Expression.NodeType"/> property equal to <see cref="F:ExpressionType.AndAlso"/> 
        /// and the <see cref="P:BinaryExpression.Left"/>, <see cref="P:BinaryExpression.Right"/>, and <see cref="P:BinaryExpression.Method"/> properties set to the FGEecified values.
        /// </returns>
        ...
        /// <param name="left">An <see cref="Expression"/> to set the <see cref="P:BinaryExpression.Left"/> property equal to.</param>
        /// <param name="right">An <see cref="Expression"/> to set the <see cref="P:BinaryExpression.Right"/> property equal to.</param>
        /// <returns>A BinaryExpression that has the NodeType property equal to Coalesce and the Left and Right properties set to the FGEecified values.</returns>
        ...
        /// <returns>A BinaryExpression that has the NodeType property equal to Coalesce and the Left, Right and Conversion properties set to the FGEecified values.
        /// </returns>
        ...
        /// and <see cref="P:BinaryExpression.Conversion"/> properties set to the FGEecified values.
        /// </returns>
        ...
        /// properties set to the FGEecified values.
        /// </returns>
        ...
        /// <returns>A BinaryExpression that has the NodeType property equal to ArrayIndex and the Left and Right properties set to the FGEecified values.</returns>
