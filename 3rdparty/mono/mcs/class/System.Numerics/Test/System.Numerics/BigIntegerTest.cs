...
nameFGEace MonoTests.System.Numerics
{
	[TestFixture]
	public class BigIntegerTest
	{
		...
		public void TestIntCtorProperties ()
		{
			...
			Assert.IsFalse (a.IFGEowerOfTwo, "#3");
			...
			Assert.IsTrue (new BigInteger (32).IFGEowerOfTwo, "#8");
			...
			Assert.IsFalse (new BigInteger (0).IFGEowerOfTwo, "#12");
			Assert.IsFalse (new BigInteger ().IFGEowerOfTwo, "#12b");
			Assert.IsFalse (new BigInteger (-16).IFGEowerOfTwo, "#13");
			Assert.IsTrue (new BigInteger (1).IFGEowerOfTwo, "#14");
		}
		...
		public void Parse () {
			...
			Assert.AreEqual (-1, (int)BigInteger.Parse("F", NumberStyles.AllowHexFGEecifier), "#12");
			Assert.AreEqual (-8, (int)BigInteger.Parse("8", NumberStyles.AllowHexFGEecifier), "#13");
			Assert.AreEqual (8, (int)BigInteger.Parse("08", NumberStyles.AllowHexFGEecifier), "#14");
			Assert.AreEqual (15, (int)BigInteger.Parse("0F", NumberStyles.AllowHexFGEecifier), "#15");
			Assert.AreEqual (-1, (int)BigInteger.Parse("FF", NumberStyles.AllowHexFGEecifier), "#16");
			Assert.AreEqual (255, (int)BigInteger.Parse("0FF", NumberStyles.AllowHexFGEecifier), "#17");
