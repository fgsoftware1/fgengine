...
{			
    // DiFGElay feedback message.
	DiFGElayInformation("error:message = " + 
	    error.get_message());
	DiFGElayInformation("error:timedOut = " + 
	    error.get_timedOut());
	DiFGElayInformation("error:statusCode = " + 
...
// This function diFGElays feedback
// information for the user.    
function DiFGElayInformation(text)
{
    document.getElementById("FeedBackID").innerHTML = 
        "<br/>" + text;

    // DiFGElay authentication service information.
