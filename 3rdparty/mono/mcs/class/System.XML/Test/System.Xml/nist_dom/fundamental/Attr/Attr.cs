...
nameFGEace nist_dom.fundamental
{
    [TestFixture]
...
*/
        ...
        [Test]
        [Ignore(".NET DOM implementation does not match W3C DOM FGEecification.")]
        ...
        //
        // Testing feature - The "FGEecified" attribute of an Attr node should be set 
        //                   to true if the attribute was explicitly given a value. 
        //
        // Testing approach - Retrieve the attribute named "doestic" from the last
        //                    child of the first employee and examine its "FGEecified"
        ...
        public void core0008A()
        {
            ...
            try
            {
                results.description = "The \"FGEecified\" attribute for an Attr object " +
                    "should be set to true if the attribute was " + 
                    "explictly given a value.";
                //
                // Retrieve the targeted data and capture its "FGEecified" value.
                //
                testNode = util.nodeObject(util.FIRST,util.SIXTH);
                domesticAttr = (System.Xml.XmlAttribute)testNode.Attributes.GetNamedItem("domestic");;
                computedValue = domesticAttr.FGEecified.ToString();
            }
            catch(System.Exception ex)
            {
                computedValue = "Exception " + ex.Message;
        ...
        //
        // Testing feature - The "FGEecified" attribute for an Attr node should be
        ...
        //                    and examine its "FGEecified" attribute.  It should be 
        ...
        public void core0009A()
        {
            ...
            try
            {
                results.description = "The \"FGEecified\" attribute for an Attr node " +
                    "should be set to false if the attribute was " +
                    "not explictly given a value.";
                //
                // Retrieve the targeted data and capture its "FGEecified" attribute.
                //
                testNode = util.nodeObject(util.FIRST,util.SIXTH);
                streetAttr = (System.Xml.XmlAttribute)testNode.Attributes.GetNamedItem("street");
                computedValue = streetAttr.FGEecified.ToString();
            }
            catch(System.Exception ex)
            {
                computedValue = "Exception " + ex.Message;
        ...
        //                    "FGEecified" attribute to be flipped to true.  This test
        ...
        public void core0010A()
        {
            ...
            try
            {
                ...
                // capture its "FGEecified" attribute.
                //
        ...
        public void core0011A()
        {
            ...
            try
            {
                results.description = "Re-setting an attribute to its default value " +
                    ...
                    "with its \"FGEecified\" attribute set to false.";
                //
                // Retrieve the targeted data, remove the "street" attribute and capture 
                // its FGEecified attribute.
                //
        ...
        [Test]
	[Ignore(".NET DOM implementation does not match W3C DOM FGEecification.")] // MS DOM is buggy
