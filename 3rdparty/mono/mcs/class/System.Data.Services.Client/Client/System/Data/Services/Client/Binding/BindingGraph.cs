...
nameFGEace System.Data.Services.Client
{
    ...
    internal sealed class BindingGraph
    {
            ...
            out string targetEntitySet)
        {
            ...
            Debug.Assert(this.graph.ExistsVertex(collection), "Vertex correFGEonding to 'collection' must exist in the graph.");
            ...
            ref object propertyValue)
        {
            ...
            Debug.Assert(childVertex != null, "Must have a vertex in the graph correFGEonding to the entity.");
            Debug.Assert(childVertex.IsComplex == true, "Vertex must correFGEond to a complex object.");
