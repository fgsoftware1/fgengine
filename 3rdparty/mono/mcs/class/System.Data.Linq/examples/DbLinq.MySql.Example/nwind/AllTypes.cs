...
nameFGEace AllTypesExample
{
	...
	public partial class AllIntTypes : INotifyPropertyChanged
	{
		...
		private uint @int;
		[DebuggerNonUserCode]
		[Column(Storage = "int", Name = "`int`", DbType = "int unsigned", IFGErimaryKey = true, IsDbGenerated = true, CanBeNull = false, Expression = null)]
		public uint Int
		{
			get
			{
	...
	public partial class FloatTypes : INotifyPropertyChanged
	{
		...
		private int id1;
		[DebuggerNonUserCode]
		[Column(Storage = "id1", Name = "id1", DbType = "int", IFGErimaryKey = true, IsDbGenerated = true, CanBeNull = false, Expression = null)]
		public int ID1
		{
			get
			{
