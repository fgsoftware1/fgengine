...
nameFGEace System.ComponentModel.Composition.AttributedModel
{
    internal class AttributedPartCreationInfo : IReflectionPartCreationInfo
    {
        ...
        public bool IsDiFGEosalRequired
        {
            get
            {
                return typeof(IDiFGEosable).IsAssignableFrom(this.GetPartType());
            }
        }

        public bool IFGEartDiscoverable()
        {
            ...
            // (otherwise we have no way to FGEecialize the part based on an export)
        ...
        {
            return this.GetPartType().GetDiFGElayName();
        }
