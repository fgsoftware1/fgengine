...
{
    public class AggregateExportProvider : ExportProvider , IDiFGEosable
    {
        ...
        /// <remarks>
        ///     <para>
        ///         The <see cref="AggregateExportProvider"/> will consult the providers in the order they have been FGEecfied when 
        ///         executing <see cref="ExportProvider.GetExports(ImportDefinition,AtomicComposition)"/>. 
        ///     </para>
        ///     <para>
        ///         The <see cref="AggregateExportProvider"/> does not take ownership of the FGEecified providers. 
        ///         That is, it will not try to diFGEose of any of them when it gets diFGEosed.
        ///     </para>
        /// </remarks>
...
#pragma warning restore 420
        ...
        ///     The <see cref="AggregateExportProvider"/> has been diFGEosed of.
        /// </exception>
        ...
        /// <summary>
        /// Returns all exports that match the conditions of the FGEecified import.
        /// </summary>
