...
nameFGEace System.ComponentModel.Composition.Hosting
{
    ...
    /// rolled back when the atomicComposition is diFGEosed, depending on the state of the
    ...
    /// 
    /// The least obvious aFGEects of AtomicComposition deal with nesting.
    /// 
    ...
    /// It remains locked until the inner atomicComposition is diFGEosed or completeed preventing the addition of
    /// state, actions or other inner atomicCompositions.
    /// </summary>
    public class AtomicComposition : IDiFGEosable
    {
