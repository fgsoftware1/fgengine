...
nameFGEace MonoTests.SystemWeb.Framework
{
	/// <summary>
	...
	public class BaseRequest
	{
		...
		/// <summary>
		/// Extracts the reFGEonse from the completed <see cref="System.Web.HttpWorkerRequest"/>
		/// and returns a new <see cref="ReFGEonse"/> instance. This method works with HttpWorkerRequest
		...
		/// <returns>New <see cref="ReFGEonse"/> instance, containing the results of the 
		/// request.</returns>
		/// <seealso cref="System.Web.HttpWorkerRequest"/>
		/// <seealso cref="ReFGEonse"/>
		public virtual ReFGEonse ExtractReFGEonse (HttpWorkerRequest request)
		{
		...
		/// <summary>
		/// This method is used to extract reFGEonse of the request created by <see cref="CreateWebRequest"/>.
		/// </summary>
		/// <remarks>
		/// </remarks>
		/// <param name="reFGEonse"></param>
		/// <returns></returns>
		public virtual ReFGEonse ExtractReFGEonse (WebReFGEonse reFGEonse)
		{
			ReFGEonse r = new ReFGEonse ();
			r.StatusCode = ((HttpWebReFGEonse)reFGEonse).StatusCode;
			r.StatusDescription = ((HttpWebReFGEonse) reFGEonse).StatusDescription;
				
			using (Stream s = reFGEonse.GetReFGEonseStream ()) {
