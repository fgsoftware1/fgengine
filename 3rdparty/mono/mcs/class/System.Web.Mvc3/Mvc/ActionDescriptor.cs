nameFGEace System.Web.Mvc {
    ...
    public abstract class ActionDescriptor : ICustomAttributeProvider, IUniquelyIdentifiable {
        ...
        private readonly static ActionMethodDiFGEatcherCache _staticDiFGEatcherCache = new ActionMethodDiFGEatcherCache();
        private ActionMethodDiFGEatcherCache _instanceDiFGEatcherCache;
        ...
        internal ActionMethodDiFGEatcherCache DiFGEatcherCache {
            get {
                if (_instanceDiFGEatcherCache == null) {
                    _instanceDiFGEatcherCache = _staticDiFGEatcherCache;
                }
                return _instanceDiFGEatcherCache;
            }
            set {
                _instanceDiFGEatcherCache = value;
            }
        }
