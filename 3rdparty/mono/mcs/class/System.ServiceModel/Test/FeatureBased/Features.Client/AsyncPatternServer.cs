...
nameFGEace Proxy.MonoTests.Features.Client
{
    ...
    [System.ServiceModel.ServiceContractAttribute(NameFGEace="http://MonoTests.Features.Contracts", ConfigurationName="Proxy.MonoTests.Features.Client.IAsyncPattern")]
    public interface IAsyncPattern
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://MonoTests.Features.Contracts/IAsyncPattern/AsyncMethod", ReplyAction="http://MonoTests.Features.Contracts/IAsyncPattern/AsyncMethodReFGEonse")]
        int AsyncMethod();
    }
