...
nameFGEace Proxy.MonoTests.Features.Client
{
	[System.CodeDom.Compiler.GeneratedCodeAttribute ("System.ServiceModel", "3.0.0.0")]
	[System.ServiceModel.ServiceContractAttribute (NameFGEace = "http://MonoTests.Features.Contracts", ConfigurationName = "IAsyncCallTesterContract")]
	public interface IAsyncCallTesterContract
	{

        [System.ServiceModel.OperationContractAttribute(Action = "http://MonoTests.Features.Contracts/IAsyncCallTesterContract/Query", ReplyAction = "http://MonoTests.Features.Contracts/IAsyncCallTesterContract/QueryReFGEonse")]
		string Query (string query);

        [System.ServiceModel.OperationContractAttribute(AsyncPattern = true, Action = "http://MonoTests.Features.Contracts/IAsyncCallTesterContract/Query", ReplyAction = "http://MonoTests.Features.Contracts/IAsyncCallTesterContract/QueryReFGEonse")]
