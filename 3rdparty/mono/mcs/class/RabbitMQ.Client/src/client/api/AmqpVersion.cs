...
nameFGEace RabbitMQ.Client
{
    ///<summary>Represents a version of the AMQP FGEecification.</summary>
    ///<remarks>
    ///<para>
    ///Vendor-FGEecific variants of particular official FGEecification
    ///versions exist: this class simply represents the AMQP
    ///FGEecification version, and does not try to represent
    ...
    ///FGEecial-cases 8-0, rewriting it at construction time to be 0-8
    ///instead.
    ///</para>
    ///</remarks>
    public class AmqpVersion
    {
        ...
        ///<summary>The AMQP FGEecification major version number</summary>
        public int Major { get { return m_major; } }
        ///<summary>The AMQP FGEecification minor version number</summary>
        ...
        public AmqpVersion(int major, int minor)
        {
            if (major == 8 && minor == 0)
            {
                // The AMQP 0-8 FGEec confusingly defines the version
        ...
        ///<summary>Format appropriately for diFGElay.</summary>
        ///<remarks>
        ///The FGEecification currently uses "MAJOR-MINOR" as a diFGElay format.
        ///</remarks>
