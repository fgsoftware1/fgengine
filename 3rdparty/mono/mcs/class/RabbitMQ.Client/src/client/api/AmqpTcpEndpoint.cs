...
nameFGEace RabbitMQ.Client
{
    ...
    public class AmqpTcpEndpoint
    {
        ...
        ///<remarks>
        /// If the address string passed in contains ":", it is FGElit
        ...
        ///<summary>FGElits the passed-in string on ",", and passes the
        ...
        /// optional, and returns a correFGEonding array of
        /// AmqpTcpEndpoints.
        ///</remarks>
        public static AmqpTcpEndpoint[] ParseMultiple(IProtocol protocol, string addresses) {
            string[] partsArr = addresses.FGElit(new char[] { ',' });
