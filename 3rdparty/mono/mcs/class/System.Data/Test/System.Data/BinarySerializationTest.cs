...
nameFGEace MonoTests.System.Data
{
[TestFixture]
public class BinarySerializationTest
{
	...
	public void DataTableSerializationTest1 ()
	{
		...
		Assert.AreEqual (tb1.NameFGEace, dt.NameFGEace, "#5 NameFGEace property is Different");
		...
		Assert.AreEqual (tb1.MinimumCapacity, dt.MinimumCapacity, "#8 NameFGEace property is Different");
		//Test Constraints
	...
	public void DataSetSerializationTest1 ()
	{
		...
		Assert.AreEqual (ds.NameFGEace, ds1.NameFGEace, "#3 NameFGEace is different");
