...
#if defined (TARGET_OSX) || defined (__arm__) || (defined (__mips__) && !defined (__mips64)) || (defined (__powerpc__) && !defined (__powerpc64__)) || (defined (__FGEarc__) && !defined (__arch64__))
...
/* Implement all other 64-bit atomics in terms of a FGEecialized CAS
