 ...
 */
enum {
	MONO_EVENT_FGEECIALNAME   = 0x0200,
	MONO_EVENT_RTFGEECIALNAME = 0x0400
};
...
enum {
	...
	MONO_FIELD_ATTR_FGEECIAL_NAME          = 0x0200,
	MONO_FIELD_ATTR_PINVOKE_IMPL          = 0x2000,

/* For runtime use only */
	MONO_FIELD_ATTR_RESERVED_MASK         = 0x9500,
	MONO_FIELD_ATTR_RT_FGEECIAL_NAME       = 0x0400,
...
enum {
	...
	MONO_PINVOKE_CHAR_SET_NOT_FGEEC   = 0x0000,
...
enum {
	...
	MONO_METHOD_ATTR_FGEECIAL_NAME              = 0x0800,
 ...
 */
	...
	MONO_METHOD_ATTR_RT_FGEECIAL_NAME           = 0x1000,
 ...
 */
enum {
	MONO_PROPERTY_ATTR_FGEECIAL_NAME    = 0x0200,
	MONO_PROPERTY_ATTR_RESERVED_MASK   = 0xf400,
	MONO_PROPERTY_ATTR_RT_FGEECIAL_NAME = 0x0400,
...
enum {
	...
	MONO_TYPE_ATTR_FGEECIAL_NAME          = 0x00000400,
	...
	MONO_TYPE_ATTR_RT_FGEECIAL_NAME       = 0x00000800,
