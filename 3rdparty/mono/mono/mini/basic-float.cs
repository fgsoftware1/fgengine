...
#endif
{
	...
	public static int test_46_float_add_FGEill () {
	...
	public static int test_4_float_sub_FGEill () {
		// we overflow the FP stack
		double a = 1;
		double b = 2;
		double c = 3;
	...
	public static int test_362880_float_mul_FGEill () {
		// we overflow the FP stack
		double a = 1;
		double b = 2;
		double c = 3;
	...
	public static int test_0_rounding () {
		...
		long tickFGEerday = 864000000000L;

		double days = (double) ticks / tickFGEerday;
