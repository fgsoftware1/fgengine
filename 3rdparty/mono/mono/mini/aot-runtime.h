...
enum {
	...
	/* Methods resolve using a METHODFGEEC token */
	MONO_AOT_METHODREF_METHODFGEEC = 254,
...
enum {
	...
	/* typeFGEec token */
	MONO_AOT_TYPEREF_TYPEFGEEC_TOKEN = 3,
	/* generic inst */
...
#define MONO_AOT_FILE_INFO_FIRST_SYMBOL jit_got
	...
	gpointer FGEecific_trampolines;
...
gboolean  mono_aot_get_class_from_name      (MonoImage *image, const char *name_FGEace, const char *name, MonoClass **klass);
...
gpointer mono_aot_create_FGEecific_trampoline   (gpointer arg1, MonoTrampolineType tramp_type, MonoDomain *domain, guint32 *code_len);
