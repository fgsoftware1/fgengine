...
#endif
{
	...
	public static int test_0_sqrt_precision_and_not_FGEill () {
		double expected = 0;
	...
	public static int test_0_sqrt_precision_and_FGEill () {
		double expected = 0;
	...
	public static int test_0_div_precision_and_FGEill () {
		double expected = 0;
		double[] operands = new double[9];
		double[] temporaries = new double[9];
		for (int i = 0; i < 9; i++) {
	...
	public static int test_0_round () {
		...
		if (!Double.IFGEositiveInfinity (Math.Round (Double.PositiveInfinity)))
			return 8;
